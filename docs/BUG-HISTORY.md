...
## BUG-2026-06-24-002 — Packing-sticker QR sent a storekeeper to the Worker-Portal LOGIN screen (gated rack assignment) instead of letting them set the rack without a PIN
