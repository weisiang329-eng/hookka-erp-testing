-- ---------------------------------------------------------------------------
-- 0122_dashboard_snapshot.sql — Application-managed dashboard snapshot.
--
...
COMMENT ON TABLE dashboard_snapshot IS
  'Write-through snapshot of GET /api/dashboard/overview. Maintained in the same transaction as source-table writes. See migrations-postgres/0122_dashboard_snapshot.sql header for the full architecture.';
