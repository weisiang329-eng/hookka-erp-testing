...
## BUG-2026-06-24-004 — Announcement "Got it" was a DEVICE-LOCAL acknowledgement only; the office had no way to see who had read a notice, and a fresh phone / cache-clear silently suppressed the must-tap popup (enhancement: server-recorded read-receipts + remind)
