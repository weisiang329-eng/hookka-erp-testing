...
// Single source of truth — was hardcoded to a WRONG Penang entity (placeholder
// reg/address/phone), printing the wrong legal company on statements. Use the
// real HOOKKA constant.
