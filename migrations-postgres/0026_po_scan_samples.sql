...
CREATE INDEX IF NOT EXISTS idx_po_scan_customer ON po_scan_samples(customer_hint);
CREATE INDEX IF NOT EXISTS idx_po_scan_created ON po_scan_samples(created_at DESC);
