            ...
            {activeUsers.length === 0 ? (
              ...
              <>
                ...
                {/* The Houzs-style table that used to sit here is gone —
                    owner 2026-08-02:「下面的不需要」. It listed Name /
                    Department / Position / Reports to for the ten office
                    accounts only, and its Reports-to column read the legacy
                    users.reportsTo rather than the org_reporting edges, so it
                    printed "—" for people the chart above draws a line for.
                    Everything it could edit, the side drawer edits properly. */}
              </>
            )}
          </CardContent>
        </Card>
