...
import roundedPriceRepair from "./import-completion/rounded-price-repair";
import supplierPriceRefresh from "./import-completion/supplier-price-refresh";
...
app.route("/", roundedPriceRepair);
app.route("/", supplierPriceRefresh);
