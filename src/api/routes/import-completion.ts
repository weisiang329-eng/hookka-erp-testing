...
// 2026-05-09: /backfill-ocr-so-fields endpoint deleted. Catalog-snap is now
// enforced live at SO POST + PUT + CO POST + PUT (commit 671b3c6) so the
// re-snap-after-the-fact cleanup tool has no remaining work. specialOrder
// catalog gate (this commit) closes the last back-door it tidied.
