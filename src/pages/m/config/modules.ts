...
const adjustmentsSource: DataSource = {
  ...
  toVM: (r): RowVM => ({
    id: str(r, "id"),
    code: str(r, "adjNo") || str(r, "id"),
    title: str(r, "itemName", "itemCode") || "—",
    subLine: str(r, "reason") || undefined,
    meta1: { label: "Qty", value: num(r, "qtyDelta") },
    meta2: { label: "Date", value: dateOnly(r, "adjustedAt") || "—" },
  }),
  columns: [
    textCol("reference", "Reference", (r) => str(r, "adjNo")),
    textCol("product", "Item", (r) => str(r, "itemName", "itemCode")),
    textCol("reason", "State", (r) => str(r, "reason")),
    dateCol("date", "Date", (r) => dateOnly(r, "adjustedAt")),
    numCol("qty", "Qty", (r) => num(r, "qtyDelta")),
  ],
  defaultSort: { key: "date", dir: "desc" },
