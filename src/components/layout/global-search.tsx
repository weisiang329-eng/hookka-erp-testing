...
const PAGE_RESULTS: SearchResult[] = [
  ...
  { id: "p-supplier-pricing", label: "Supplier Pricing", href: "/procurement/pricing", icon: DollarSign, category: "pages" },
  { id: "p-maintenance", label: "Supplier Maintenance", href: "/procurement/maintenance", icon: Building2, category: "pages" },
