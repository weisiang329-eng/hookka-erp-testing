...
CREATE INDEX IF NOT EXISTS idx_worker_sessions_workerId
  ON worker_sessions(workerId);

CREATE INDEX IF NOT EXISTS idx_worker_sessions_expiresAt
  ON worker_sessions(expiresAt);
