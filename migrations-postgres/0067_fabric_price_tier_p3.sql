...
-- ---------------------------------------------------------------------------
ALTER TABLE fabric_tracking DROP CONSTRAINT IF EXISTS fabric_tracking_price_tier_check;
ALTER TABLE fabric_tracking ADD CONSTRAINT fabric_tracking_price_tier_check
  CHECK (price_tier IN ('PRICE_1','PRICE_2','PRICE_3'));
