...
export const departments: Department[] = [
  ...
  { id: "dept-3", code: "WOOD_CUT", name: "Wood Cutting", shortName: "Wood Cut", sequence: 3, color: "#F59E0B", workingHoursPerDay: 9 },
  { id: "dept-4", code: "FOAM", name: "Foam Bonding", shortName: "Foam", sequence: 4, color: "#8B5CF6", workingHoursPerDay: 9 },
  { id: "dept-5", code: "FRAMING", name: "Framing", shortName: "Framing", sequence: 5, color: "#F97316", workingHoursPerDay: 9 },
...
export const leaveRecords: LeaveRecord[] = [
  {
    id: "LV-001", workerId: "emp-1", workerName: "EI PHOO WEI",
    type: "ANNUAL", startDate: "2026-04-20", endDate: "2026-04-21", days: 2,
    status: "APPROVED", reason: "Family visit", approvedBy: "Admin",
  },
  {
    id: "LV-002", workerId: "emp-4", workerName: "ANN",
    type: "MEDICAL", startDate: "2026-03-15", endDate: "2026-03-16", days: 2,
    status: "APPROVED", reason: "Fever and flu", approvedBy: "Admin",
  },
  {
    id: "LV-003", workerId: "emp-7", workerName: "KHIN MAUNG LIN",
    type: "ANNUAL", startDate: "2026-05-01", endDate: "2026-05-03", days: 3,
    status: "PENDING", reason: "Personal matters",
  },
  {
    id: "LV-004", workerId: "emp-9", workerName: "HLAING MIN AUNG",
    type: "EMERGENCY", startDate: "2026-03-28", endDate: "2026-03-28", days: 1,
    status: "APPROVED", reason: "Family emergency", approvedBy: "Admin",
  },
  {
    id: "LV-005", workerId: "emp-14", workerName: "AUNG THEIN WIN",
    type: "UNPAID", startDate: "2026-04-10", endDate: "2026-04-11", days: 2,
    status: "REJECTED", reason: "Personal travel - peak season",
  },
];
...
export const equipmentList: Equipment[] = [
  { id: "eq-1", code: "EQ-SEW-001", name: "Industrial Sewing Machine #1", department: "Fabric Sewing", type: "SEWING_MACHINE", status: "OPERATIONAL", lastMaintenanceDate: "2026-03-20", nextMaintenanceDate: "2026-04-20", maintenanceCycleDays: 30, purchaseDate: "2023-01-15", notes: "Primary sewing station" },
  { id: "eq-2", code: "EQ-SEW-002", name: "Industrial Sewing Machine #2", department: "Fabric Sewing", type: "SEWING_MACHINE", status: "OPERATIONAL", lastMaintenanceDate: "2026-03-25", nextMaintenanceDate: "2026-04-25", maintenanceCycleDays: 30, purchaseDate: "2023-01-15", notes: "" },
  { id: "eq-3", code: "EQ-CUT-001", name: "CNC Fabric Cutting Table", department: "Fabric Cutting", type: "CUTTING_TABLE", status: "MAINTENANCE", lastMaintenanceDate: "2026-04-10", nextMaintenanceDate: "2026-04-10", maintenanceCycleDays: 14, purchaseDate: "2022-06-01", notes: "Blade replacement in progress" },
  { id: "eq-4", code: "EQ-SAW-001", name: "Band Saw Machine", department: "Wood Cutting", type: "SAW", status: "OPERATIONAL", lastMaintenanceDate: "2026-04-01", nextMaintenanceDate: "2026-05-01", maintenanceCycleDays: 30, purchaseDate: "2021-11-20", notes: "" },
  { id: "eq-5", code: "EQ-STP-001", name: "Pneumatic Staple Gun #1", department: "Framing", type: "STAPLE_GUN", status: "REPAIR", lastMaintenanceDate: "2026-03-15", nextMaintenanceDate: "2026-04-05", maintenanceCycleDays: 21, purchaseDate: "2023-05-10", notes: "Air seal replacement needed" },
  { id: "eq-6", code: "EQ-STP-002", name: "Pneumatic Staple Gun #2", department: "Framing", type: "STAPLE_GUN", status: "OPERATIONAL", lastMaintenanceDate: "2026-04-05", nextMaintenanceDate: "2026-04-26", maintenanceCycleDays: 21, purchaseDate: "2023-05-10", notes: "" },
  { id: "eq-7", code: "EQ-CMP-001", name: "Air Compressor 10HP", department: "Framing", type: "COMPRESSOR", status: "OPERATIONAL", lastMaintenanceDate: "2026-03-01", nextMaintenanceDate: "2026-04-30", maintenanceCycleDays: 60, purchaseDate: "2020-08-15", notes: "Shared between framing and upholstery" },
  { id: "eq-8", code: "EQ-DRL-001", name: "Power Drill Station", department: "Framing", type: "DRILL", status: "OPERATIONAL", lastMaintenanceDate: "2026-04-08", nextMaintenanceDate: "2026-05-08", maintenanceCycleDays: 30, purchaseDate: "2022-02-28", notes: "" },
  { id: "eq-9", code: "EQ-SEW-003", name: "Heavy Duty Sewing Machine", department: "Upholstery", type: "SEWING_MACHINE", status: "DECOMMISSIONED", lastMaintenanceDate: "2026-01-10", nextMaintenanceDate: "2026-02-10", maintenanceCycleDays: 30, purchaseDate: "2019-03-20", notes: "Replaced by EQ-SEW-004. Motor burnt out." },
  { id: "eq-10", code: "EQ-SEW-004", name: "Heavy Duty Sewing Machine (New)", department: "Upholstery", type: "SEWING_MACHINE", status: "OPERATIONAL", lastMaintenanceDate: "2026-04-12", nextMaintenanceDate: "2026-05-12", maintenanceCycleDays: 30, purchaseDate: "2026-02-01", notes: "Replacement for EQ-SEW-003" },
];

export const maintenanceLogs: MaintenanceLog[] = [
  { id: "ml-1", equipmentId: "eq-1", equipmentName: "Industrial Sewing Machine #1", type: "PREVENTIVE", description: "Routine oiling, belt tension check, needle replacement", performedBy: "Ahmad Razak", date: "2026-03-20", costSen: 15000, downtimeHours: 2 },
  { id: "ml-2", equipmentId: "eq-3", equipmentName: "CNC Fabric Cutting Table", type: "CORRECTIVE", description: "Blade dulling causing uneven cuts. Replaced cutting blade and recalibrated laser guide.", performedBy: "Lee Wei Ming", date: "2026-04-10", costSen: 85000, downtimeHours: 6 },
  { id: "ml-3", equipmentId: "eq-5", equipmentName: "Pneumatic Staple Gun #1", type: "EMERGENCY", description: "Air seal failure during production. Temporary fix applied, awaiting parts.", performedBy: "Lee Wei Ming", date: "2026-03-28", costSen: 5000, downtimeHours: 3 },
  { id: "ml-4", equipmentId: "eq-7", equipmentName: "Air Compressor 10HP", type: "PREVENTIVE", description: "Filter cleaning, oil change, pressure gauge calibration", performedBy: "Ahmad Razak", date: "2026-03-01", costSen: 25000, downtimeHours: 4 },
  { id: "ml-5", equipmentId: "eq-4", equipmentName: "Band Saw Machine", type: "PREVENTIVE", description: "Blade replacement, guide bearing check, table alignment", performedBy: "Ahmad Razak", date: "2026-04-01", costSen: 35000, downtimeHours: 3 },
  { id: "ml-6", equipmentId: "eq-9", equipmentName: "Heavy Duty Sewing Machine", type: "EMERGENCY", description: "Motor burnt out during production. Machine decommissioned.", performedBy: "Lee Wei Ming", date: "2026-01-10", costSen: 0, downtimeHours: 8 },
  { id: "ml-7", equipmentId: "eq-2", equipmentName: "Industrial Sewing Machine #2", type: "PREVENTIVE", description: "Thread tension calibration, bobbin case cleaning, feed dog adjustment", performedBy: "Ahmad Razak", date: "2026-03-25", costSen: 12000, downtimeHours: 1.5 },
  { id: "ml-8", equipmentId: "eq-10", equipmentName: "Heavy Duty Sewing Machine (New)", type: "PREVENTIVE", description: "Initial break-in maintenance. First 500-hour service completed.", performedBy: "Ahmad Razak", date: "2026-04-12", costSen: 8000, downtimeHours: 2 },
];
...
export const mrpRuns: MRPRun[] = [
  {
    id: "mrp-run-001",
    runDate: "2026-04-14T08:30:00Z",
    planningHorizon: "2 weeks",
    ...
    requirements: [
      {
        id: "mr-1",
        materialName: "BM Fabric (PC151/PC200)",
        materialCategory: "BM_FABRIC",
        unit: "METER",
        grossRequired: 520,
        onHand: 450,
        onOrder: 0,
        ...
        preferredSupplierName: "Tex-Fabric Sdn Bhd",
      },
      {
        id: "mr-2",
        materialName: "SM Fabric (KN390/Ninja)",
      ...
      {
        id: "mr-4",
        materialName: "Wood Strip 2x4",
        materialCategory: "WD_STRIP",
        unit: "PCS",
        grossRequired: 120,
        onHand: 500,
        onOrder: 0,
      ...
      {
        id: "mr-5",
        materialName: "High Density Foam",
        materialCategory: "B_FILLER",
        unit: "SHEET",
        grossRequired: 42,
        onHand: 45,
        onOrder: 0,
        ...
        preferredSupplierName: "Foamtech Industries",
      },
      {
        id: "mr-6",
        materialName: "Sofa Cushion Foam",
        materialCategory: "S_FILLER",
        unit: "SHEET",
        grossRequired: 28,
        onHand: 60,
        onOrder: 0,
      ...
      {
        id: "mr-7",
        materialName: "Elastic Webbing",
        materialCategory: "WEBBING",
        unit: "ROLL",
        grossRequired: 18,
        onHand: 25,
        onOrder: 0,
      ...
      },
      {
        ...
        preferredSupplierName: "PackRight Supplies",
      },
      {
        id: "mr-9",
        materialName: "Bed Mechanism Set",
        materialCategory: "MECHANISM",
        unit: "SET",
        grossRequired: 15,
        onHand: 60,
        onOrder: 0,
...
export const bankAccounts: BankAccount[] = [
  {
    id: "ba-1",
    bankName: "Maybank",
    accountNo: "5142-8830-7621",
    accountName: "HOOKKA INDUSTRIES SDN BHD",
    balanceSen: 28540000,
    currency: "MYR",
  },
  {
...
export const bankTransactions: BankTransaction[] = [
  { id: "bt-1", bankAccountId: "ba-1", date: "2026-04-14", description: "TRF IN - HOUZS CENTURY SDN BHD", amountSen: 1500000, type: "DEPOSIT", reference: "TRF-20260414-001", isReconciled: true, matchedJournalId: "je-1" },
  { id: "bt-2", bankAccountId: "ba-1", date: "2026-04-14", description: "Payment - Kain Utama Sdn Bhd", amountSen: -800000, type: "WITHDRAWAL", reference: "CHQ-20260414-101", isReconciled: true, matchedJournalId: "je-2" },
  { id: "bt-3", bankAccountId: "ba-1", date: "2026-04-13", description: "TRF IN - THE CONTS SDN BHD", amountSen: 320000, type: "DEPOSIT", reference: "TRF-20260413-002", isReconciled: true },
  { id: "bt-4", bankAccountId: "ba-1", date: "2026-04-12", description: "Payroll - April Week 2", amountSen: -3775000, type: "WITHDRAWAL", reference: "PAY-20260412-001", isReconciled: true, matchedJournalId: "je-3" },
  { id: "bt-5", bankAccountId: "ba-1", date: "2026-04-11", description: "TNB Electricity Bill", amountSen: -320000, type: "WITHDRAWAL", reference: "DD-20260411-TNB", isReconciled: true, matchedJournalId: "je-4" },
  { id: "bt-6", bankAccountId: "ba-1", date: "2026-04-10", description: "TRF IN - CARRESS SDN BHD", amountSen: 2200000, type: "DEPOSIT", reference: "TRF-20260410-003", isReconciled: false },
  { id: "bt-7", bankAccountId: "ba-1", date: "2026-04-09", description: "Insurance Premium - Allianz", amountSen: -450000, type: "WITHDRAWAL", reference: "DD-20260409-ALZ", isReconciled: false },
  { id: "bt-8", bankAccountId: "ba-1", date: "2026-04-08", description: "TRF IN - HOUZS PG", amountSen: 680000, type: "DEPOSIT", reference: "TRF-20260408-004", isReconciled: false },
  { id: "bt-9", bankAccountId: "ba-2", date: "2026-04-14", description: "TRF IN - HOUZS SRW", amountSen: 950000, type: "DEPOSIT", reference: "TRF-20260414-005", isReconciled: false },
  { id: "bt-10", bankAccountId: "ba-2", date: "2026-04-13", description: "Payment - Papan Jaya Trading", amountSen: -630000, type: "WITHDRAWAL", reference: "CHQ-20260413-102", isReconciled: false },
  { id: "bt-11", bankAccountId: "ba-2", date: "2026-04-12", description: "TRF IN - HOUZS SBH", amountSen: 420000, type: "DEPOSIT", reference: "TRF-20260412-006", isReconciled: false },
  { id: "bt-12", bankAccountId: "ba-2", date: "2026-04-10", description: "Payment - Foam Industries", amountSen: -256000, type: "WITHDRAWAL", reference: "CHQ-20260410-103", isReconciled: false },
  { id: "bt-13", bankAccountId: "ba-2", date: "2026-04-07", description: "Transfer to Maybank", amountSen: -500000, type: "TRANSFER", reference: "IBG-20260407-001", isReconciled: false },
  { id: "bt-14", bankAccountId: "ba-1", date: "2026-04-07", description: "Transfer from CIMB", amountSen: 500000, type: "TRANSFER", reference: "IBG-20260407-001", isReconciled: false },
  { id: "bt-15", bankAccountId: "ba-2", date: "2026-04-05", description: "TRF IN - HOUZS KL", amountSen: 854000, type: "DEPOSIT", reference: "TRF-20260405-007", isReconciled: false },
];
...
export const approvalRequests: ApprovalRequest[] = [
  {
    id: "apr-001",
    type: "PRICE_OVERRIDE",
    referenceNo: "SO-2026-0042",
    referenceId: "so-042",
    title: "Price override for SERA 3-Seater",
    description: "Customer DERA DESIGN requested 8% below list price for bulk order of 20 units SERA 3-Seater sofas.",
    requestedBy: "Ahmad Faizal",
    requestedAt: "2026-04-14T09:15:00+08:00",
    status: "PENDING",
    amountSen: 1560000,
    metadata: { "Original Price": "RM 16,900.00", "Requested Price": "RM 15,600.00", "Quantity": "20", "Customer": "DERA DESIGN SDN BHD" },
  },
  {
    id: "apr-002",
    type: "DISCOUNT",
    referenceNo: "SO-2026-0039",
    referenceId: "so-039",
    title: "15% volume discount for ZARA HOME",
    description: "Sales team requests 15% volume discount on mixed order totaling RM 89,400. Exceeds 10% auto-approval threshold.",
    requestedBy: "Siti Nurhaliza",
    requestedAt: "2026-04-14T08:30:00+08:00",
    status: "PENDING",
    amountSen: 1341000,
    metadata: { "Discount %": "15%", "Order Total": "RM 89,400.00", "Discount Amount": "RM 13,410.00", "Customer": "ZARA HOME MY" },
  },
  {
    id: "apr-003",
    type: "PO_APPROVAL",
    referenceNo: "PO-2026-0118",
    referenceId: "po-118",
    title: "Purchase Order - Imported Italian Leather",
    description: "Procurement raised PO for 500 sq ft of premium Italian leather from Milano Pellami. Amount exceeds departmental limit.",
    requestedBy: "Lee Wei Ming",
    requestedAt: "2026-04-13T16:45:00+08:00",
    status: "PENDING",
    amountSen: 4250000,
    metadata: { "Supplier": "Milano Pellami Srl", "Material": "Premium Italian Leather", "Quantity": "500 sq ft", "Lead Time": "45 days" },
  },
  {
    id: "apr-004",
    type: "LEAVE_REQUEST",
    referenceNo: "LV-2026-0056",
    referenceId: "lv-056",
    title: "Annual leave - Rajan (Upholstery)",
    description: "Rajan from Upholstery department requests 5 days annual leave from 21-25 April 2026. Department has 2 other staff on leave.",
    requestedBy: "Rajan A/L Muthu",
    requestedAt: "2026-04-13T14:00:00+08:00",
    status: "PENDING",
    metadata: { "Department": "Upholstery", "Leave Type": "Annual Leave", "Duration": "5 days", "From": "21 Apr 2026", "To": "25 Apr 2026" },
  },
  {
    id: "apr-005",
    type: "STOCK_ADJUSTMENT",
    referenceNo: "SA-2026-0023",
    referenceId: "sa-023",
    title: "Stock write-off - Damaged plywood batch",
    description: "Warehouse reports water damage to 30 sheets of 18mm plywood (Batch PW-2026-B12). Requesting write-off from inventory.",
    requestedBy: "Tan Ah Kow",
    requestedAt: "2026-04-13T11:20:00+08:00",
    status: "PENDING",
    amountSen: 720000,
    metadata: { "Item": "Plywood 18mm", "Quantity": "30 sheets", "Batch": "PW-2026-B12", "Reason": "Water damage", "Location": "Warehouse A" },
  },
  {
    id: "apr-006",
    type: "CREDIT_OVERRIDE",
    referenceNo: "CR-2026-0009",
    referenceId: "cr-009",
    title: "Credit limit override - DECO WORLD",
    description: "DECO WORLD has exceeded credit limit by RM 25,000. Sales requests temporary override to fulfill urgent order.",
    requestedBy: "Ahmad Faizal",
    requestedAt: "2026-04-12T15:30:00+08:00",
    status: "PENDING",
    amountSen: 2500000,
    metadata: { "Customer": "DECO WORLD SDN BHD", "Current Limit": "RM 100,000.00", "Outstanding": "RM 112,500.00", "New Order": "RM 12,500.00" },
  },
  {
    id: "apr-007",
    type: "SO_CANCELLATION",
    referenceNo: "SO-2026-0031",
    referenceId: "so-031",
    title: "Cancel SO - PINNACLE LIVING (customer request)",
    description: "Customer PINNACLE LIVING requests full cancellation. Production has not started. Fabric already cut for 2 items.",
    requestedBy: "Siti Nurhaliza",
    requestedAt: "2026-04-12T10:00:00+08:00",
    status: "PENDING",
    amountSen: 3400000,
    metadata: { "Customer": "PINNACLE LIVING SDN BHD", "Items": "4", "Production Status": "Not started (2), Fabric cut (2)", "Restocking Fee": "RM 680.00" },
  },
  {
    id: "apr-008",
    type: "DISCOUNT",
    referenceNo: "SO-2026-0028",
    referenceId: "so-028",
    title: "Trade discount 12% for CASA DERA",
    description: "Approved 12% trade discount for returning customer CASA DERA. Within GM threshold.",
    requestedBy: "Ahmad Faizal",
    requestedAt: "2026-04-11T14:15:00+08:00",
    status: "APPROVED",
    approvedBy: "Encik Hakimi",
    approvedAt: "2026-04-11T16:30:00+08:00",
    amountSen: 576000,
    metadata: { "Discount %": "12%", "Order Total": "RM 48,000.00", "Discount Amount": "RM 5,760.00", "Customer": "CASA DERA" },
  },
  {
    id: "apr-009",
    type: "PO_APPROVAL",
    referenceNo: "PO-2026-0105",
    referenceId: "po-105",
    title: "PO Approved - Webbing material restock",
    description: "Regular restock of elastic webbing rolls from local supplier. Within budget allocation.",
    requestedBy: "Lee Wei Ming",
    requestedAt: "2026-04-10T09:00:00+08:00",
    status: "APPROVED",
    approvedBy: "Encik Hakimi",
    approvedAt: "2026-04-10T10:15:00+08:00",
    amountSen: 850000,
    metadata: { "Supplier": "KL Webbing Supplies", "Material": "Elastic Webbing 3-inch", "Quantity": "50 rolls" },
  },
  {
    id: "apr-010",
    type: "PRICE_OVERRIDE",
    referenceNo: "SO-2026-0025",
    referenceId: "so-025",
    title: "Price override rejected - Below cost margin",
    description: "Requested price of RM 8,500 for LUXE 2-Seater is below manufacturing cost. Override rejected.",
    requestedBy: "Siti Nurhaliza",
    requestedAt: "2026-04-09T11:00:00+08:00",
    status: "REJECTED",
    approvedBy: "Encik Hakimi",
    approvedAt: "2026-04-09T14:00:00+08:00",
    reason: "Requested price is below manufacturing cost of RM 9,200. Minimum acceptable price is RM 10,120 (10% margin).",
    amountSen: 850000,
    metadata: { "Original Price": "RM 12,500.00", "Requested Price": "RM 8,500.00", "Manufacturing Cost": "RM 9,200.00", "Customer": "BUDGET HOMES" },
  },
  {
    id: "apr-011",
    type: "LEAVE_REQUEST",
    referenceNo: "LV-2026-0051",
    referenceId: "lv-051",
    title: "Medical leave - Wong (Packing)",
    description: "MC approved for Wong from Packing. 2 days medical leave with doctor's note.",
    requestedBy: "Wong Chee Keong",
    requestedAt: "2026-04-08T08:00:00+08:00",
    status: "APPROVED",
    approvedBy: "Supervisor Lim",
    approvedAt: "2026-04-08T08:30:00+08:00",
    metadata: { "Department": "Packing", "Leave Type": "Medical Leave", "Duration": "2 days", "From": "08 Apr 2026", "To": "09 Apr 2026" },
  },
  {
    id: "apr-012",
    type: "STOCK_ADJUSTMENT",
    referenceNo: "SA-2026-0019",
    referenceId: "sa-019",
    title: "Cycle count adjustment - Foam inventory",
    description: "Rejected stock adjustment of +15 foam blocks. Physical count does not match system. Requires recount.",
    requestedBy: "Tan Ah Kow",
    requestedAt: "2026-04-07T16:00:00+08:00",
    status: "REJECTED",
    approvedBy: "Encik Hakimi",
    approvedAt: "2026-04-08T09:00:00+08:00",
    reason: "Variance too large (+15 blocks). Please conduct a full recount with 2 counters and submit supporting photos.",
    amountSen: 225000,
    metadata: { "Item": "High Density Foam Block", "System Qty": "120", "Physical Qty": "135", "Variance": "+15" },
  },
];
...
export const consignmentNotes: ConsignmentNote[] = [
  {
    id: "con-001",
    noteNumber: "CON-2601-001",
    type: "OUT",
    customerId: "cust-1",
    customerName: "Houzs Century",
    branchName: "HOUZS KL",
    items: [
      { id: "coni-001", productId: "prod-1", productName: "Astoria Bedframe", productCode: "1009(A)", quantity: 1, unitPrice: 185000, status: "AT_BRANCH", soldDate: null, returnedDate: null },
      { id: "coni-002", productId: "prod-2", productName: "Vienna Bedframe", productCode: "1003(A)", quantity: 1, unitPrice: 220000, status: "SOLD", soldDate: "2026-02-20", returnedDate: null },
      { id: "coni-003", productId: "prod-5", productName: "Nordic 3-Seater Sofa", productCode: "5535-2A", quantity: 1, unitPrice: 280000, status: "SOLD", soldDate: "2026-03-05", returnedDate: null },
    ],
    sentDate: "2026-01-15",
    status: "PARTIALLY_SOLD",
    totalValue: 685000,
    notes: "Display units for KL showroom.",
  },
  {
    id: "con-002",
    noteNumber: "CON-2601-002",
    type: "OUT",
    customerId: "cust-1",
    customerName: "Houzs Century",
    branchName: "HOUZS PG",
    items: [
      { id: "coni-004", productId: "prod-3", productName: "Oslo Bedframe", productCode: "1013", quantity: 1, unitPrice: 165000, status: "AT_BRANCH", soldDate: null, returnedDate: null },
      { id: "coni-005", productId: "prod-6", productName: "Nordic 2-Seater Sofa", productCode: "5535-1NA", quantity: 1, unitPrice: 210000, status: "AT_BRANCH", soldDate: null, returnedDate: null },
    ],
    sentDate: "2026-01-20",
    status: "ACTIVE",
    totalValue: 375000,
    notes: "Penang showroom display set.",
  },
  {
    id: "con-003",
    noteNumber: "CON-2602-001",
    type: "OUT",
    customerId: "cust-1",
    customerName: "Houzs Century",
    branchName: "HOUZS SRW",
    items: [
      { id: "coni-006", productId: "prod-4", productName: "Milano Bedframe", productCode: "2038(A)", quantity: 1, unitPrice: 320000, status: "SOLD", soldDate: "2026-03-10", returnedDate: null },
      { id: "coni-007", productId: "prod-7", productName: "Nordic Corner Sofa", productCode: "5535-CNR", quantity: 1, unitPrice: 180000, status: "SOLD", soldDate: "2026-03-18", returnedDate: null },
      { id: "coni-008", productId: "prod-8", productName: "Standard Divan", productCode: "DV-STD", quantity: 2, unitPrice: 45000, status: "SOLD", soldDate: "2026-04-01", returnedDate: null },
    ],
    sentDate: "2026-02-10",
    status: "FULLY_SOLD",
    totalValue: 590000,
    notes: "Kuching branch consignment batch.",
  },
  {
    id: "con-004",
    noteNumber: "CON-2603-001",
    type: "OUT",
    customerId: "cust-1",
    customerName: "Houzs Century",
    branchName: "HOUZS SBH",
    items: [
      { id: "coni-009", productId: "prod-1", productName: "Astoria Bedframe", productCode: "1009(A)", quantity: 1, unitPrice: 185000, status: "AT_BRANCH", soldDate: null, returnedDate: null },
      { id: "coni-010", productId: "prod-3", productName: "Oslo Bedframe", productCode: "1013", quantity: 1, unitPrice: 165000, status: "DAMAGED", soldDate: null, returnedDate: "2026-04-05" },
    ],
    sentDate: "2026-03-01",
    status: "ACTIVE",
    totalValue: 350000,
    notes: "KK showroom. Oslo frame damaged in transit.",
  },
  {
    id: "con-005",
    noteNumber: "CON-2604-001",
    type: "OUT",
    customerId: "cust-1",
    customerName: "Houzs Century",
    branchName: "HOUZS KL",
    items: [
      { id: "coni-011", productId: "prod-4", productName: "Milano Bedframe", productCode: "2038(A)", quantity: 1, unitPrice: 320000, status: "AT_BRANCH", soldDate: null, returnedDate: null },
      { id: "coni-012", productId: "prod-6", productName: "Nordic 2-Seater Sofa", productCode: "5535-1NA", quantity: 2, unitPrice: 210000, status: "AT_BRANCH", soldDate: null, returnedDate: null },
    ],
    sentDate: "2026-04-05",
    status: "ACTIVE",
    totalValue: 740000,
    notes: "New arrivals for KL showroom April display.",
  },
  {
    id: "con-006",
    noteNumber: "CON-2603-002",
    type: "RETURN",
    customerId: "cust-1",
    customerName: "Houzs Century",
    branchName: "HOUZS PG",
    items: [
      { id: "coni-013", productId: "prod-8", productName: "Standard Divan", productCode: "DV-STD", quantity: 1, unitPrice: 45000, status: "RETURNED", soldDate: null, returnedDate: "2026-03-25" },
    ],
    sentDate: "2026-03-25",
    status: "RETURNED",
    totalValue: 45000,
    notes: "Customer returned divan - wrong colour selected.",
  },
  {
    id: "con-007",
    noteNumber: "CON-2604-002",
    type: "OUT",
    customerId: "cust-1",
    customerName: "Houzs Century",
    branchName: "HOUZS SRW",
    items: [
      { id: "coni-014", productId: "prod-2", productName: "HILTON(A) BEDFRAME", productCode: "1003(A)", quantity: 1, unitPrice: 56000, status: "AT_BRANCH", soldDate: null, returnedDate: null },
      { id: "coni-015", productId: "prod-4", productName: "CODY BEDFRAME", productCode: "1007", quantity: 1, unitPrice: 52000, status: "AT_BRANCH", soldDate: null, returnedDate: null },
    ],
    sentDate: "2026-04-02",
    status: "ACTIVE",
    totalValue: 108000,
    notes: "In-transit to Kuching via DO-2604-001 / DO-2604-004 - ETA mid April",
  },
  {
    id: "con-008",
    noteNumber: "CON-2604-003",
    type: "OUT",
    customerId: "cust-2",
    customerName: "Carress",
    branchName: "CARRESS KL",
    items: [
      { id: "coni-016", productId: "prod-7", productName: "JAGER BEDFRAME", productCode: "1013", quantity: 2, unitPrice: 40000, status: "SOLD", soldDate: "2026-04-13", returnedDate: null },
      { id: "coni-017", productId: "prod-4", productName: "CODY BEDFRAME", productCode: "1007", quantity: 1, unitPrice: 40000, status: "SOLD", soldDate: "2026-04-13", returnedDate: null },
    ],
    sentDate: "2026-04-10",
    status: "FULLY_SOLD",
    totalValue: 120000,
    notes: "Delivered via DO-2604-010 - all units sold through at Carress Klang",
  },
];
...
export const historicalSales: HistoricalSales[] = [
  // Astoria Bedframe (prod-1)
  { productId: "prod-1", productCode: "1009(A)", productName: "Astoria Bedframe", period: "2025-05", quantity: 42, revenue: 651000000, customerId: "cust-1", customerName: "Houzs Century" },
  { productId: "prod-1", productCode: "1009(A)", productName: "Astoria Bedframe", period: "2025-06", quantity: 38, revenue: 589000000, customerId: "cust-1", customerName: "Houzs Century" },
  { productId: "prod-1", productCode: "1009(A)", productName: "Astoria Bedframe", period: "2025-07", quantity: 35, revenue: 542500000, customerId: "cust-1", customerName: "Houzs Century" },
  { productId: "prod-1", productCode: "1009(A)", productName: "Astoria Bedframe", period: "2025-08", quantity: 40, revenue: 620000000, customerId: "cust-2", customerName: "CARRESS SDN BHD" },
  { productId: "prod-1", productCode: "1009(A)", productName: "Astoria Bedframe", period: "2025-09", quantity: 45, revenue: 697500000, customerId: "cust-1", customerName: "Houzs Century" },
  { productId: "prod-1", productCode: "1009(A)", productName: "Astoria Bedframe", period: "2025-10", quantity: 55, revenue: 852500000, customerId: "cust-2", customerName: "CARRESS SDN BHD" },
  { productId: "prod-1", productCode: "1009(A)", productName: "Astoria Bedframe", period: "2025-11", quantity: 60, revenue: 930000000, customerId: "cust-1", customerName: "Houzs Century" },
  { productId: "prod-1", productCode: "1009(A)", productName: "Astoria Bedframe", period: "2025-12", quantity: 58, revenue: 899000000, customerId: "cust-3", customerName: "The Conts" },
  { productId: "prod-1", productCode: "1009(A)", productName: "Astoria Bedframe", period: "2026-01", quantity: 30, revenue: 465000000, customerId: "cust-1", customerName: "Houzs Century" },
  { productId: "prod-1", productCode: "1009(A)", productName: "Astoria Bedframe", period: "2026-02", quantity: 35, revenue: 542500000, customerId: "cust-1", customerName: "Houzs Century" },
  { productId: "prod-1", productCode: "1009(A)", productName: "Astoria Bedframe", period: "2026-03", quantity: 52, revenue: 806000000, customerId: "cust-2", customerName: "CARRESS SDN BHD" },
  { productId: "prod-1", productCode: "1009(A)", productName: "Astoria Bedframe", period: "2026-04", quantity: 48, revenue: 744000000, customerId: "cust-1", customerName: "Houzs Century" },
  // Vienna Bedframe (prod-2)
  { productId: "prod-2", productCode: "1003(A)", productName: "Vienna Bedframe", period: "2025-05", quantity: 28, revenue: 518000000, customerId: "cust-2", customerName: "CARRESS SDN BHD" },
  { productId: "prod-2", productCode: "1003(A)", productName: "Vienna Bedframe", period: "2025-06", quantity: 30, revenue: 555000000, customerId: "cust-1", customerName: "Houzs Century" },
  { productId: "prod-2", productCode: "1003(A)", productName: "Vienna Bedframe", period: "2025-07", quantity: 25, revenue: 462500000, customerId: "cust-1", customerName: "Houzs Century" },
  { productId: "prod-2", productCode: "1003(A)", productName: "Vienna Bedframe", period: "2025-08", quantity: 32, revenue: 592000000, customerId: "cust-2", customerName: "CARRESS SDN BHD" },
  { productId: "prod-2", productCode: "1003(A)", productName: "Vienna Bedframe", period: "2025-09", quantity: 36, revenue: 666000000, customerId: "cust-1", customerName: "Houzs Century" },
  { productId: "prod-2", productCode: "1003(A)", productName: "Vienna Bedframe", period: "2025-10", quantity: 45, revenue: 832500000, customerId: "cust-3", customerName: "The Conts" },
  { productId: "prod-2", productCode: "1003(A)", productName: "Vienna Bedframe", period: "2025-11", quantity: 50, revenue: 925000000, customerId: "cust-2", customerName: "CARRESS SDN BHD" },
  { productId: "prod-2", productCode: "1003(A)", productName: "Vienna Bedframe", period: "2025-12", quantity: 48, revenue: 888000000, customerId: "cust-1", customerName: "Houzs Century" },
  { productId: "prod-2", productCode: "1003(A)", productName: "Vienna Bedframe", period: "2026-01", quantity: 28, revenue: 518000000, customerId: "cust-1", customerName: "Houzs Century" },
  { productId: "prod-2", productCode: "1003(A)", productName: "Vienna Bedframe", period: "2026-02", quantity: 33, revenue: 610500000, customerId: "cust-2", customerName: "CARRESS SDN BHD" },
  { productId: "prod-2", productCode: "1003(A)", productName: "Vienna Bedframe", period: "2026-03", quantity: 42, revenue: 777000000, customerId: "cust-1", customerName: "Houzs Century" },
  { productId: "prod-2", productCode: "1003(A)", productName: "Vienna Bedframe", period: "2026-04", quantity: 40, revenue: 740000000, customerId: "cust-2", customerName: "CARRESS SDN BHD" },
  // Nordic 3-Seater Sofa (prod-5)
  { productId: "prod-5", productCode: "5535-2A", productName: "Nordic 3-Seater Sofa", period: "2025-05", quantity: 18, revenue: 504000000, customerId: "cust-1", customerName: "Houzs Century" },
  { productId: "prod-5", productCode: "5535-2A", productName: "Nordic 3-Seater Sofa", period: "2025-06", quantity: 15, revenue: 420000000, customerId: "cust-3", customerName: "The Conts" },
  { productId: "prod-5", productCode: "5535-2A", productName: "Nordic 3-Seater Sofa", period: "2025-07", quantity: 12, revenue: 336000000, customerId: "cust-1", customerName: "Houzs Century" },
  { productId: "prod-5", productCode: "5535-2A", productName: "Nordic 3-Seater Sofa", period: "2025-08", quantity: 20, revenue: 560000000, customerId: "cust-1", customerName: "Houzs Century" },
  { productId: "prod-5", productCode: "5535-2A", productName: "Nordic 3-Seater Sofa", period: "2025-09", quantity: 22, revenue: 616000000, customerId: "cust-2", customerName: "CARRESS SDN BHD" },
  { productId: "prod-5", productCode: "5535-2A", productName: "Nordic 3-Seater Sofa", period: "2025-10", quantity: 30, revenue: 840000000, customerId: "cust-1", customerName: "Houzs Century" },
  { productId: "prod-5", productCode: "5535-2A", productName: "Nordic 3-Seater Sofa", period: "2025-11", quantity: 35, revenue: 980000000, customerId: "cust-3", customerName: "The Conts" },
  { productId: "prod-5", productCode: "5535-2A", productName: "Nordic 3-Seater Sofa", period: "2025-12", quantity: 32, revenue: 896000000, customerId: "cust-1", customerName: "Houzs Century" },
  { productId: "prod-5", productCode: "5535-2A", productName: "Nordic 3-Seater Sofa", period: "2026-01", quantity: 14, revenue: 392000000, customerId: "cust-1", customerName: "Houzs Century" },
  { productId: "prod-5", productCode: "5535-2A", productName: "Nordic 3-Seater Sofa", period: "2026-02", quantity: 18, revenue: 504000000, customerId: "cust-1", customerName: "Houzs Century" },
  { productId: "prod-5", productCode: "5535-2A", productName: "Nordic 3-Seater Sofa", period: "2026-03", quantity: 25, revenue: 700000000, customerId: "cust-2", customerName: "CARRESS SDN BHD" },
  { productId: "prod-5", productCode: "5535-2A", productName: "Nordic 3-Seater Sofa", period: "2026-04", quantity: 22, revenue: 616000000, customerId: "cust-1", customerName: "Houzs Century" },
  // Standard Divan (prod-8)
  { productId: "prod-8", productCode: "DV-STD", productName: "Standard Divan", period: "2025-05", quantity: 85, revenue: 382500000, customerId: "cust-1", customerName: "Houzs Century" },
  { productId: "prod-8", productCode: "DV-STD", productName: "Standard Divan", period: "2025-06", quantity: 80, revenue: 360000000, customerId: "cust-1", customerName: "Houzs Century" },
  { productId: "prod-8", productCode: "DV-STD", productName: "Standard Divan", period: "2025-07", quantity: 75, revenue: 337500000, customerId: "cust-1", customerName: "Houzs Century" },
  { productId: "prod-8", productCode: "DV-STD", productName: "Standard Divan", period: "2025-08", quantity: 82, revenue: 369000000, customerId: "cust-1", customerName: "Houzs Century" },
  { productId: "prod-8", productCode: "DV-STD", productName: "Standard Divan", period: "2025-09", quantity: 90, revenue: 405000000, customerId: "cust-1", customerName: "Houzs Century" },
  { productId: "prod-8", productCode: "DV-STD", productName: "Standard Divan", period: "2025-10", quantity: 105, revenue: 472500000, customerId: "cust-1", customerName: "Houzs Century" },
  { productId: "prod-8", productCode: "DV-STD", productName: "Standard Divan", period: "2025-11", quantity: 110, revenue: 495000000, customerId: "cust-2", customerName: "CARRESS SDN BHD" },
  { productId: "prod-8", productCode: "DV-STD", productName: "Standard Divan", period: "2025-12", quantity: 100, revenue: 450000000, customerId: "cust-1", customerName: "Houzs Century" },
  { productId: "prod-8", productCode: "DV-STD", productName: "Standard Divan", period: "2026-01", quantity: 65, revenue: 292500000, customerId: "cust-1", customerName: "Houzs Century" },
  { productId: "prod-8", productCode: "DV-STD", productName: "Standard Divan", period: "2026-02", quantity: 72, revenue: 324000000, customerId: "cust-1", customerName: "Houzs Century" },
  { productId: "prod-8", productCode: "DV-STD", productName: "Standard Divan", period: "2026-03", quantity: 95, revenue: 427500000, customerId: "cust-2", customerName: "CARRESS SDN BHD" },
  { productId: "prod-8", productCode: "DV-STD", productName: "Standard Divan", period: "2026-04", quantity: 88, revenue: 396000000, customerId: "cust-1", customerName: "Houzs Century" },
  // Milano Bedframe (prod-4)
  { productId: "prod-4", productCode: "2038(A)", productName: "Milano Bedframe", period: "2025-05", quantity: 10, revenue: 270000000, customerId: "cust-2", customerName: "CARRESS SDN BHD" },
  { productId: "prod-4", productCode: "2038(A)", productName: "Milano Bedframe", period: "2025-06", quantity: 8, revenue: 216000000, customerId: "cust-1", customerName: "Houzs Century" },
  { productId: "prod-4", productCode: "2038(A)", productName: "Milano Bedframe", period: "2025-07", quantity: 7, revenue: 189000000, customerId: "cust-3", customerName: "The Conts" },
  { productId: "prod-4", productCode: "2038(A)", productName: "Milano Bedframe", period: "2025-08", quantity: 12, revenue: 324000000, customerId: "cust-2", customerName: "CARRESS SDN BHD" },
  { productId: "prod-4", productCode: "2038(A)", productName: "Milano Bedframe", period: "2025-09", quantity: 14, revenue: 378000000, customerId: "cust-1", customerName: "Houzs Century" },
  { productId: "prod-4", productCode: "2038(A)", productName: "Milano Bedframe", period: "2025-10", quantity: 18, revenue: 486000000, customerId: "cust-2", customerName: "CARRESS SDN BHD" },
  { productId: "prod-4", productCode: "2038(A)", productName: "Milano Bedframe", period: "2025-11", quantity: 22, revenue: 594000000, customerId: "cust-3", customerName: "The Conts" },
  { productId: "prod-4", productCode: "2038(A)", productName: "Milano Bedframe", period: "2025-12", quantity: 20, revenue: 540000000, customerId: "cust-1", customerName: "Houzs Century" },
  { productId: "prod-4", productCode: "2038(A)", productName: "Milano Bedframe", period: "2026-01", quantity: 9, revenue: 243000000, customerId: "cust-2", customerName: "CARRESS SDN BHD" },
  { productId: "prod-4", productCode: "2038(A)", productName: "Milano Bedframe", period: "2026-02", quantity: 13, revenue: 351000000, customerId: "cust-1", customerName: "Houzs Century" },
  { productId: "prod-4", productCode: "2038(A)", productName: "Milano Bedframe", period: "2026-03", quantity: 17, revenue: 459000000, customerId: "cust-2", customerName: "CARRESS SDN BHD" },
  { productId: "prod-4", productCode: "2038(A)", productName: "Milano Bedframe", period: "2026-04", quantity: 15, revenue: 405000000, customerId: "cust-3", customerName: "The Conts" },
];

export const forecastEntries: ForecastEntry[] = [
  { id: "fc-1", productId: "prod-1", productName: "Astoria Bedframe", productCode: "1009(A)", period: "2026-05", forecastQty: 45, actualQty: null, method: "SMA_3", confidence: 78, createdDate: "2026-04-10" },
  { id: "fc-2", productId: "prod-1", productName: "Astoria Bedframe", productCode: "1009(A)", period: "2026-06", forecastQty: 40, actualQty: null, method: "SMA_3", confidence: 72, createdDate: "2026-04-10" },
  { id: "fc-3", productId: "prod-1", productName: "Astoria Bedframe", productCode: "1009(A)", period: "2026-07", forecastQty: 37, actualQty: null, method: "SMA_3", confidence: 65, createdDate: "2026-04-10" },
  { id: "fc-4", productId: "prod-1", productName: "Astoria Bedframe", productCode: "1009(A)", period: "2026-08", forecastQty: 42, actualQty: null, method: "SMA_3", confidence: 60, createdDate: "2026-04-10" },
  { id: "fc-5", productId: "prod-1", productName: "Astoria Bedframe", productCode: "1009(A)", period: "2026-09", forecastQty: 48, actualQty: null, method: "SMA_3", confidence: 55, createdDate: "2026-04-10" },
  { id: "fc-6", productId: "prod-1", productName: "Astoria Bedframe", productCode: "1009(A)", period: "2026-10", forecastQty: 56, actualQty: null, method: "SMA_3", confidence: 50, createdDate: "2026-04-10" },
  { id: "fc-7", productId: "prod-2", productName: "Vienna Bedframe", productCode: "1003(A)", period: "2026-05", forecastQty: 38, actualQty: null, method: "SMA_6", confidence: 80, createdDate: "2026-04-10" },
  { id: "fc-8", productId: "prod-2", productName: "Vienna Bedframe", productCode: "1003(A)", period: "2026-06", forecastQty: 35, actualQty: null, method: "SMA_6", confidence: 75, createdDate: "2026-04-10" },
  { id: "fc-9", productId: "prod-2", productName: "Vienna Bedframe", productCode: "1003(A)", period: "2026-07", forecastQty: 30, actualQty: null, method: "SMA_6", confidence: 68, createdDate: "2026-04-10" },
  { id: "fc-10", productId: "prod-2", productName: "Vienna Bedframe", productCode: "1003(A)", period: "2026-08", forecastQty: 34, actualQty: null, method: "SMA_6", confidence: 62, createdDate: "2026-04-10" },
  { id: "fc-11", productId: "prod-2", productName: "Vienna Bedframe", productCode: "1003(A)", period: "2026-09", forecastQty: 40, actualQty: null, method: "SMA_6", confidence: 56, createdDate: "2026-04-10" },
  { id: "fc-12", productId: "prod-2", productName: "Vienna Bedframe", productCode: "1003(A)", period: "2026-10", forecastQty: 47, actualQty: null, method: "SMA_6", confidence: 50, createdDate: "2026-04-10" },
  { id: "fc-13", productId: "prod-5", productName: "Nordic 3-Seater Sofa", productCode: "5535-2A", period: "2026-05", forecastQty: 20, actualQty: null, method: "WMA", confidence: 82, createdDate: "2026-04-10" },
  { id: "fc-14", productId: "prod-5", productName: "Nordic 3-Seater Sofa", productCode: "5535-2A", period: "2026-06", forecastQty: 17, actualQty: null, method: "WMA", confidence: 76, createdDate: "2026-04-10" },
  { id: "fc-15", productId: "prod-5", productName: "Nordic 3-Seater Sofa", productCode: "5535-2A", period: "2026-07", forecastQty: 14, actualQty: null, method: "WMA", confidence: 70, createdDate: "2026-04-10" },
  { id: "fc-16", productId: "prod-5", productName: "Nordic 3-Seater Sofa", productCode: "5535-2A", period: "2026-08", forecastQty: 21, actualQty: null, method: "WMA", confidence: 64, createdDate: "2026-04-10" },
  { id: "fc-17", productId: "prod-5", productName: "Nordic 3-Seater Sofa", productCode: "5535-2A", period: "2026-09", forecastQty: 24, actualQty: null, method: "WMA", confidence: 58, createdDate: "2026-04-10" },
  { id: "fc-18", productId: "prod-5", productName: "Nordic 3-Seater Sofa", productCode: "5535-2A", period: "2026-10", forecastQty: 32, actualQty: null, method: "WMA", confidence: 52, createdDate: "2026-04-10" },
  { id: "fc-19", productId: "prod-8", productName: "Standard Divan", productCode: "DV-STD", period: "2026-05", forecastQty: 85, actualQty: null, method: "SMA_3", confidence: 85, createdDate: "2026-04-10" },
  { id: "fc-20", productId: "prod-8", productName: "Standard Divan", productCode: "DV-STD", period: "2026-06", forecastQty: 80, actualQty: null, method: "SMA_3", confidence: 80, createdDate: "2026-04-10" },
  { id: "fc-21", productId: "prod-8", productName: "Standard Divan", productCode: "DV-STD", period: "2026-07", forecastQty: 76, actualQty: null, method: "SMA_3", confidence: 74, createdDate: "2026-04-10" },
  { id: "fc-22", productId: "prod-8", productName: "Standard Divan", productCode: "DV-STD", period: "2026-08", forecastQty: 82, actualQty: null, method: "SMA_3", confidence: 68, createdDate: "2026-04-10" },
  { id: "fc-23", productId: "prod-8", productName: "Standard Divan", productCode: "DV-STD", period: "2026-09", forecastQty: 92, actualQty: null, method: "SMA_3", confidence: 62, createdDate: "2026-04-10" },
  { id: "fc-24", productId: "prod-8", productName: "Standard Divan", productCode: "DV-STD", period: "2026-10", forecastQty: 105, actualQty: null, method: "SMA_3", confidence: 56, createdDate: "2026-04-10" },
  { id: "fc-25", productId: "prod-4", productName: "Milano Bedframe", productCode: "2038(A)", period: "2026-05", forecastQty: 13, actualQty: null, method: "WMA", confidence: 75, createdDate: "2026-04-10" },
  { id: "fc-26", productId: "prod-4", productName: "Milano Bedframe", productCode: "2038(A)", period: "2026-06", forecastQty: 11, actualQty: null, method: "WMA", confidence: 70, createdDate: "2026-04-10" },
  { id: "fc-27", productId: "prod-4", productName: "Milano Bedframe", productCode: "2038(A)", period: "2026-07", forecastQty: 9, actualQty: null, method: "WMA", confidence: 64, createdDate: "2026-04-10" },
  { id: "fc-28", productId: "prod-4", productName: "Milano Bedframe", productCode: "2038(A)", period: "2026-08", forecastQty: 14, actualQty: null, method: "WMA", confidence: 58, createdDate: "2026-04-10" },
  { id: "fc-29", productId: "prod-4", productName: "Milano Bedframe", productCode: "2038(A)", period: "2026-09", forecastQty: 16, actualQty: null, method: "WMA", confidence: 52, createdDate: "2026-04-10" },
  { id: "fc-30", productId: "prod-4", productName: "Milano Bedframe", productCode: "2038(A)", period: "2026-10", forecastQty: 20, actualQty: null, method: "WMA", confidence: 46, createdDate: "2026-04-10" },
];

export const promiseDateCalcs: PromiseDateCalc[] = [
  { productId: "prod-1", currentQueueDays: 5, materialAvailability: "IN_STOCK", estimatedCompletionDays: 8, promiseDate: "2026-04-22" },
  { productId: "prod-2", currentQueueDays: 7, materialAvailability: "IN_STOCK", estimatedCompletionDays: 10, promiseDate: "2026-04-24" },
  { productId: "prod-3", currentQueueDays: 3, materialAvailability: "PARTIAL", estimatedCompletionDays: 12, promiseDate: "2026-04-26" },
  { productId: "prod-4", currentQueueDays: 10, materialAvailability: "NEED_ORDER", estimatedCompletionDays: 21, promiseDate: "2026-05-05" },
  { productId: "prod-5", currentQueueDays: 8, materialAvailability: "IN_STOCK", estimatedCompletionDays: 12, promiseDate: "2026-04-26" },
  { productId: "prod-6", currentQueueDays: 4, materialAvailability: "IN_STOCK", estimatedCompletionDays: 7, promiseDate: "2026-04-21" },
  { productId: "prod-7", currentQueueDays: 6, materialAvailability: "PARTIAL", estimatedCompletionDays: 14, promiseDate: "2026-04-28" },
  { productId: "prod-8", currentQueueDays: 2, materialAvailability: "IN_STOCK", estimatedCompletionDays: 5, promiseDate: "2026-04-19" },
];
...
export const rdProjects: RDProject[] = [
  {
    id: "rd-001",
    code: "RD-2604-001",
    name: "Modular L-Shape Sofa",
    description: "Modular sofa system with interchangeable sections. Target: affordable luxury segment.",
    projectType: "DEVELOPMENT",
    productCategory: "SOFA",
    currentStage: "CONCEPT",
    targetLaunchDate: "2026-09-01",
    assignedTeam: ["Ahmad Razif", "Tan Mei Ling"],
    milestones: [
      { stage: "CONCEPT", targetDate: "2026-04-30", actualDate: null, approvedBy: null },
      { stage: "DESIGN", targetDate: "2026-05-31", actualDate: null, approvedBy: null },
      { stage: "PROTOTYPE", targetDate: "2026-06-30", actualDate: null, approvedBy: null },
      { stage: "TESTING", targetDate: "2026-07-15", actualDate: null, approvedBy: null },
      { stage: "APPROVED", targetDate: "2026-08-01", actualDate: null, approvedBy: null },
      { stage: "PRODUCTION_READY", targetDate: "2026-08-15", actualDate: null, approvedBy: null },
    ],
    totalBudget: 1500000,
    actualCost: 120000,
    prototypes: [
      { id: "proto-001a", projectId: "rd-001", prototypeType: "FRAMING" as const, version: "v1", description: "Initial foam density and frame concept sketch with 3D rendering", materialsCost: 80000, labourHours: 12, testResults: "Pending", feedback: "Concept looks promising. Need to explore fabric options.", improvements: "", defects: "Frame joints need reinforcement. Foam density too low for long-term durability.", createdDate: "2026-04-10T09:00:00+08:00" },
    ],
    createdDate: "2026-04-05T10:00:00+08:00",
    status: "ACTIVE",
  },
  {
    id: "rd-002",
    code: "RD-2603-002",
    name: "Adjustable Headboard Bedframe",
    description: "King-size bedframe with motorized adjustable headboard and integrated USB charging.",
    projectType: "DEVELOPMENT",
    productCategory: "BEDFRAME",
    currentStage: "DESIGN",
    targetLaunchDate: "2026-08-15",
    assignedTeam: ["Lee Wei Jian", "Nurul Aisyah", "Tan Mei Ling"],
    milestones: [
      { stage: "CONCEPT", targetDate: "2026-03-15", actualDate: "2026-03-14", approvedBy: "Encik Hakimi" },
      { stage: "DESIGN", targetDate: "2026-04-30", actualDate: null, approvedBy: null },
      { stage: "PROTOTYPE", targetDate: "2026-05-31", actualDate: null, approvedBy: null },
      { stage: "TESTING", targetDate: "2026-06-30", actualDate: null, approvedBy: null },
      { stage: "APPROVED", targetDate: "2026-07-15", actualDate: null, approvedBy: null },
      { stage: "PRODUCTION_READY", targetDate: "2026-08-01", actualDate: null, approvedBy: null },
    ],
    totalBudget: 2000000,
    actualCost: 350000,
    prototypes: [
      { id: "proto-002a", projectId: "rd-002", prototypeType: "FRAMING" as const, version: "v1", description: "CAD design of adjustable mechanism with motor placement", materialsCost: 150000, labourHours: 24, testResults: "Motor torque sufficient for 45-degree adjustment", feedback: "Reduce motor noise. Consider adding soft-close mechanism.", improvements: "", defects: "Motor noise too loud at 55dB. No cable management solution. Missing soft-close.", createdDate: "2026-03-20T14:00:00+08:00" },
      { id: "proto-002b", projectId: "rd-002", prototypeType: "FRAMING" as const, version: "v2", description: "Revised design with soft-close damper and cable management", materialsCost: 200000, labourHours: 18, testResults: "Pending material sourcing for damper", feedback: "Good improvement. Proceed to full-scale prototype after design review.", improvements: "Added soft-close damper. Motor noise reduced to 40dB. Cable management integrated.", defects: "Damper sourcing uncertain. Cable routing needs refinement for mass production.", createdDate: "2026-04-08T10:00:00+08:00" },
    ],
    createdDate: "2026-03-01T09:00:00+08:00",
    status: "ACTIVE",
  },
  {
    id: "rd-003",
    code: "RD-2602-003",
    name: "Compact 2-Seater Recliner",
    description: "Space-saving 2-seater sofa with built-in recliner for urban apartments. Wall-hugger design.",
    projectType: "DEVELOPMENT",
    productCategory: "SOFA",
    currentStage: "PROTOTYPE",
    targetLaunchDate: "2026-07-01",
    assignedTeam: ["Ahmad Razif", "Wong Chee Keong", "Siti Aminah"],
    milestones: [
      { stage: "CONCEPT", targetDate: "2026-02-15", actualDate: "2026-02-12", approvedBy: "Encik Hakimi" },
      { stage: "DESIGN", targetDate: "2026-03-15", actualDate: "2026-03-18", approvedBy: "Lee Wei Jian" },
      { stage: "PROTOTYPE", targetDate: "2026-04-30", actualDate: null, approvedBy: null },
      { stage: "TESTING", targetDate: "2026-05-15", actualDate: null, approvedBy: null },
      { stage: "APPROVED", targetDate: "2026-06-01", actualDate: null, approvedBy: null },
      { stage: "PRODUCTION_READY", targetDate: "2026-06-15", actualDate: null, approvedBy: null },
    ],
    totalBudget: 1800000,
    actualCost: 920000,
    prototypes: [
      { id: "proto-003a", projectId: "rd-003", prototypeType: "FRAMING" as const, version: "v1", description: "First physical prototype with basic recliner mechanism", materialsCost: 350000, labourHours: 40, testResults: "Recliner mechanism works but feels stiff. Frame slightly oversized.", feedback: "Reduce frame width by 5cm. Lubricate pivot points.", improvements: "", defects: "Recliner mechanism stiff. Frame 5cm too wide. Pivot points need lubrication.", createdDate: "2026-03-25T08:00:00+08:00" },
      { id: "proto-003b", projectId: "rd-003", prototypeType: "FRAMING" as const, version: "v2", description: "Refined prototype with slimmer frame and improved mechanism", materialsCost: 380000, labourHours: 36, testResults: "Smooth reclining action. Fits within target dimensions.", feedback: "Excellent improvement. Ready for durability testing.", improvements: "Frame width reduced 5cm. Pivot points lubricated. Smooth reclining action.", defects: "Fabric attachment points not finalized. Need durability testing.", createdDate: "2026-04-12T09:00:00+08:00" },
      { id: "proto-003c", projectId: "rd-003", prototypeType: "FABRIC_SEWING" as const, version: "v3", description: "Final prototype with production-grade fabric and foam", materialsCost: 190000, labourHours: 20, testResults: "In progress - durability and comfort testing", feedback: "Pending test completion", improvements: "Using production-grade fabric. Foam density optimized.", defects: "Pending durability test results.", createdDate: "2026-04-14T10:00:00+08:00" },
    ],
    createdDate: "2026-02-01T09:00:00+08:00",
    status: "ACTIVE",
  },
  {
    id: "rd-004",
    code: "RD-2601-004",
    name: "Waterproof Outdoor Cushion Set",
    description: "UV-resistant and waterproof outdoor cushion set with quick-dry foam core for tropical climate.",
    projectType: "DEVELOPMENT",
    productCategory: "ACCESSORY",
    currentStage: "TESTING",
    targetLaunchDate: "2026-06-01",
    assignedTeam: ["Nurul Aisyah", "Siti Aminah"],
    milestones: [
      { stage: "CONCEPT", targetDate: "2026-01-15", actualDate: "2026-01-10", approvedBy: "Encik Hakimi" },
      { stage: "DESIGN", targetDate: "2026-02-15", actualDate: "2026-02-14", approvedBy: "Lee Wei Jian" },
      { stage: "PROTOTYPE", targetDate: "2026-03-15", actualDate: "2026-03-12", approvedBy: "Lee Wei Jian" },
      { stage: "TESTING", targetDate: "2026-04-30", actualDate: null, approvedBy: null },
      { stage: "APPROVED", targetDate: "2026-05-15", actualDate: null, approvedBy: null },
      { stage: "PRODUCTION_READY", targetDate: "2026-05-25", actualDate: null, approvedBy: null },
    ],
    totalBudget: 800000,
    actualCost: 520000,
    prototypes: [
      { id: "proto-004a", projectId: "rd-004", prototypeType: "FABRIC_SEWING" as const, version: "v1", description: "Initial sample with outdoor fabric and standard foam", materialsCost: 120000, labourHours: 8, testResults: "Fabric passed UV test (500hrs). Foam retained water - failed drainage test.", feedback: "Switch to open-cell quick-dry foam. Re-test.", improvements: "", defects: "Foam retained water — failed drainage test. Need open-cell quick-dry foam.", createdDate: "2026-03-05T11:00:00+08:00" },
      { id: "proto-004b", projectId: "rd-004", prototypeType: "FABRIC_SEWING" as const, version: "v2", description: "Revised with quick-dry open-cell foam and drainage channels", materialsCost: 180000, labourHours: 10, testResults: "Water drains in <30 min. UV resistance maintained. In 30-day outdoor exposure test.", feedback: "Looking good. Awaiting full 30-day exposure results.", improvements: "Switched to open-cell quick-dry foam. Added drainage channels.", defects: "Awaiting 30-day outdoor exposure test results.", createdDate: "2026-04-01T09:00:00+08:00" },
    ],
    createdDate: "2026-01-05T09:00:00+08:00",
    status: "ACTIVE",
  },
  {
    id: "rd-005",
    code: "RD-2512-005",
    name: "Premium Storage Bedframe",
    description: "Queen-size bedframe with hydraulic lift storage and integrated LED ambient lighting. 450L capacity.",
    projectType: "DEVELOPMENT",
    productCategory: "BEDFRAME",
    currentStage: "APPROVED",
    targetLaunchDate: "2026-05-01",
    assignedTeam: ["Lee Wei Jian", "Ahmad Razif", "Wong Chee Keong"],
    milestones: [
      { stage: "CONCEPT", targetDate: "2025-12-15", actualDate: "2025-12-10", approvedBy: "Encik Hakimi" },
      { stage: "DESIGN", targetDate: "2026-01-15", actualDate: "2026-01-12", approvedBy: "Encik Hakimi" },
      { stage: "PROTOTYPE", targetDate: "2026-02-15", actualDate: "2026-02-18", approvedBy: "Lee Wei Jian" },
      { stage: "TESTING", targetDate: "2026-03-15", actualDate: "2026-03-10", approvedBy: "Lee Wei Jian" },
      { stage: "APPROVED", targetDate: "2026-04-01", actualDate: "2026-04-02", approvedBy: "Encik Hakimi" },
      { stage: "PRODUCTION_READY", targetDate: "2026-04-20", actualDate: null, approvedBy: null },
    ],
    totalBudget: 2500000,
    actualCost: 2150000,
    prototypes: [
      { id: "proto-005a", projectId: "rd-005", prototypeType: "FRAMING" as const, version: "v1", description: "First prototype with basic hydraulic lift mechanism", materialsCost: 450000, labourHours: 48, testResults: "Lift mechanism works. LED wiring needs improvement.", feedback: "Strengthen base panel. Improve LED diffusion.", improvements: "", defects: "LED wiring exposed. Base panel flex under load. LED diffusion uneven.", createdDate: "2026-02-10T09:00:00+08:00" },
      { id: "proto-005b", projectId: "rd-005", prototypeType: "FABRIC_SEWING" as const, version: "v2", description: "Production-ready prototype with improved LED strip and reinforced base", materialsCost: 520000, labourHours: 40, testResults: "Passed 10,000 cycle lift test. LED colour temp approved. Weight capacity: 250kg verified.", feedback: "Approved for production. Prepare BOM and routing.", improvements: "Base panel reinforced. LED diffusion improved with acrylic strip. Wiring hidden.", defects: "", createdDate: "2026-03-15T10:00:00+08:00" },
    ],
    productionBOM: [
      { id: "rdbom-001", materialCode: "RM-WD-001", materialName: "Plywood 18mm", qty: 4, unit: "PCS", unitCostSen: 4500 },
      { id: "rdbom-002", materialCode: "RM-WD-002", materialName: "Pine Wood Frame 2x4", qty: 6, unit: "PCS", unitCostSen: 3200 },
      { id: "rdbom-003", materialCode: "RM-HW-001", materialName: "Hydraulic Lift Gas Strut", qty: 2, unit: "PCS", unitCostSen: 8500 },
      { id: "rdbom-004", materialCode: "RM-HW-002", materialName: "LED Strip 5m", qty: 1, unit: "ROLL", unitCostSen: 3500 },
      { id: "rdbom-005", materialCode: "RM-HW-003", materialName: "Hinge Heavy Duty", qty: 4, unit: "PCS", unitCostSen: 1200 },
      { id: "rdbom-006", materialCode: "RM-SP-003", materialName: "Screw Pack M6", qty: 2, unit: "BOX", unitCostSen: 800 },
    ],
    materialIssuances: [
      { id: "rdmi-001", rdProjectId: "rd-005", rdProjectCode: "RD-2512-005", materialId: "rm-1", materialCode: "18MM 4' X 8'", materialName: "18MM 4' X 8' MR AA PLYWOOD", qty: 4, unit: "PCS", unitCostSen: 4500, totalCostSen: 18000, issuedDate: "2026-02-08", issuedBy: "Ahmad Razif", notes: "For base panel prototype" },
      { id: "rdmi-002", rdProjectId: "rd-005", rdProjectCode: "RD-2512-005", materialId: "rm-4", materialCode: "9MM 4' X 8'", materialName: "9MM 4' X 8' MR AA PLYWOOD", qty: 2, unit: "PCS", unitCostSen: 3200, totalCostSen: 6400, issuedDate: "2026-02-08", issuedBy: "Ahmad Razif", notes: "For side panels" },
    ],
    labourLogs: [
      { id: "rdlb-001", rdProjectId: "rd-005", workerName: "Ahmad Razif", department: "R&D", hours: 8, date: "2026-02-08", description: "Frame cutting and assembly for v1 prototype" },
      { id: "rdlb-002", rdProjectId: "rd-005", workerName: "Tan Mei Ling", department: "R&D", hours: 6, date: "2026-02-09", description: "LED wiring and hydraulic lift installation" },
      { id: "rdlb-003", rdProjectId: "rd-005", workerName: "Ahmad Razif", department: "R&D", hours: 10, date: "2026-03-12", description: "v2 prototype reinforcement and LED diffusion improvement" },
    ],
    createdDate: "2025-12-01T09:00:00+08:00",
    status: "ACTIVE",
  },
];
...
export const lorries: LorryInfo[] = [
  { id: "lorry-1", name: "Lorry 1", plateNumber: "WA 1234 B", capacity: 25, driverName: "Ahmad bin Hassan", driverContact: "012-3456789", status: "AVAILABLE" },
  { id: "lorry-2", name: "Lorry 2", plateNumber: "WA 5678 C", capacity: 18, driverName: "Muthu a/l Rajan", driverContact: "017-8765432", status: "AVAILABLE" },
  { id: "lorry-3", name: "Lorry 3", plateNumber: "WB 9012 D", capacity: 30, driverName: "Tan Wei Ming", driverContact: "016-2345678", status: "IN_USE" },
];
...
export const plEntries: PLEntry[] = [
  // ===== JANUARY 2026 =====
  // Revenue - Bedframe
  { id: plId(), period: "2026-01", accountCode: "400-1001", accountName: "Sales - Bedframe", category: "REVENUE", amount: 12545500, productCategory: "BEDFRAME", customerId: "hub-houzs-kl", customerName: "Houzs KL", state: "KL" },
  { id: plId(), period: "2026-01", accountCode: "400-1001", accountName: "Sales - Bedframe", category: "REVENUE", amount: 8730000, productCategory: "BEDFRAME", customerId: "hub-houzs-pg", customerName: "Houzs PG", state: "PG" },
  { id: plId(), period: "2026-01", accountCode: "400-1001", accountName: "Sales - Bedframe", category: "REVENUE", amount: 5918200, productCategory: "BEDFRAME", customerId: "hub-houzs-srw", customerName: "Houzs SRW", state: "SRW" },
  { id: plId(), period: "2026-01", accountCode: "400-1001", accountName: "Sales - Bedframe", category: "REVENUE", amount: 3272700, productCategory: "BEDFRAME", customerId: "hub-houzs-sbh", customerName: "Houzs SBH", state: "SBH" },
  { id: plId(), period: "2026-01", accountCode: "400-1001", accountName: "Sales - Bedframe", category: "REVENUE", amount: 9090900, productCategory: "BEDFRAME", customerId: "hub-carress", customerName: "Carress", state: "KL" },
  { id: plId(), period: "2026-01", accountCode: "400-1001", accountName: "Sales - Bedframe", category: "REVENUE", amount: 4545500, productCategory: "BEDFRAME", customerId: "hub-conts", customerName: "The Conts", state: "JB" },
  // Revenue - Sofa
  { id: plId(), period: "2026-01", accountCode: "400-1002", accountName: "Sales - Sofa", category: "REVENUE", amount: 15909100, productCategory: "SOFA", customerId: "hub-houzs-kl", customerName: "Houzs KL", state: "KL" },
  { id: plId(), period: "2026-01", accountCode: "400-1002", accountName: "Sales - Sofa", category: "REVENUE", amount: 10909100, productCategory: "SOFA", customerId: "hub-houzs-pg", customerName: "Houzs PG", state: "PG" },
  { id: plId(), period: "2026-01", accountCode: "400-1002", accountName: "Sales - Sofa", category: "REVENUE", amount: 6363600, productCategory: "SOFA", customerId: "hub-carress", customerName: "Carress", state: "KL" },
  { id: plId(), period: "2026-01", accountCode: "400-1002", accountName: "Sales - Sofa", category: "REVENUE", amount: 3636400, productCategory: "SOFA", customerId: "hub-conts", customerName: "The Conts", state: "JB" },
  // Revenue - Accessories
  { id: plId(), period: "2026-01", accountCode: "400-1003", accountName: "Sales - Accessories", category: "REVENUE", amount: 1818200, productCategory: "ACCESSORY", customerId: "hub-houzs-kl", customerName: "Houzs KL", state: "KL" },
  { id: plId(), period: "2026-01", accountCode: "400-1003", accountName: "Sales - Accessories", category: "REVENUE", amount: 909100, productCategory: "ACCESSORY", customerId: "hub-carress", customerName: "Carress", state: "KL" },
  // COGS - January
  { id: plId(), period: "2026-01", accountCode: "330-1001", accountName: "COGS - BM Fabric", category: "COGS", amount: 8500000, productCategory: "ALL" },
  { id: plId(), period: "2026-01", accountCode: "330-1002", accountName: "COGS - SM Fabric", category: "COGS", amount: 6200000, productCategory: "ALL" },
  { id: plId(), period: "2026-01", accountCode: "330-1003", accountName: "COGS - Plywood", category: "COGS", amount: 4800000, productCategory: "ALL" },
  { id: plId(), period: "2026-01", accountCode: "330-1004", accountName: "COGS - Wood Strip", category: "COGS", amount: 2100000, productCategory: "ALL" },
  { id: plId(), period: "2026-01", accountCode: "330-1005", accountName: "COGS - Foam & Filler", category: "COGS", amount: 5600000, productCategory: "ALL" },
  { id: plId(), period: "2026-01", accountCode: "330-1006", accountName: "COGS - Accessories", category: "COGS", amount: 1500000, productCategory: "ALL" },
  { id: plId(), period: "2026-01", accountCode: "330-1007", accountName: "COGS - Webbing", category: "COGS", amount: 800000, productCategory: "ALL" },
  { id: plId(), period: "2026-01", accountCode: "330-1008", accountName: "COGS - Packing", category: "COGS", amount: 1200000, productCategory: "ALL" },
  { id: plId(), period: "2026-01", accountCode: "330-1009", accountName: "COGS - Direct Labour", category: "COGS", amount: 9500000, productCategory: "ALL" },
  // Operating Expenses - January
  { id: plId(), period: "2026-01", accountCode: "500-1001", accountName: "Salaries & Wages (Admin)", category: "OPERATING_EXPENSE", amount: 4500000 },
  { id: plId(), period: "2026-01", accountCode: "500-1002", accountName: "EPF & SOCSO", category: "OPERATING_EXPENSE", amount: 1200000 },
  { id: plId(), period: "2026-01", accountCode: "500-1003", accountName: "Rental - Factory", category: "OPERATING_EXPENSE", amount: 2800000 },
  { id: plId(), period: "2026-01", accountCode: "500-1004", accountName: "Utilities", category: "OPERATING_EXPENSE", amount: 850000 },
  { id: plId(), period: "2026-01", accountCode: "500-1005", accountName: "Depreciation", category: "OPERATING_EXPENSE", amount: 1500000 },
  { id: plId(), period: "2026-01", accountCode: "500-1006", accountName: "Transport & Delivery", category: "OPERATING_EXPENSE", amount: 2200000 },
  { id: plId(), period: "2026-01", accountCode: "500-1007", accountName: "Insurance", category: "OPERATING_EXPENSE", amount: 350000 },
  { id: plId(), period: "2026-01", accountCode: "500-1008", accountName: "Maintenance & Repairs", category: "OPERATING_EXPENSE", amount: 450000 },
  { id: plId(), period: "2026-01", accountCode: "500-1009", accountName: "Office Supplies", category: "OPERATING_EXPENSE", amount: 180000 },

  // ===== FEBRUARY 2026 =====
  // Revenue - Bedframe
  { id: plId(), period: "2026-02", accountCode: "400-1001", accountName: "Sales - Bedframe", category: "REVENUE", amount: 13818200, productCategory: "BEDFRAME", customerId: "hub-houzs-kl", customerName: "Houzs KL", state: "KL" },
  { id: plId(), period: "2026-02", accountCode: "400-1001", accountName: "Sales - Bedframe", category: "REVENUE", amount: 9545500, productCategory: "BEDFRAME", customerId: "hub-houzs-pg", customerName: "Houzs PG", state: "PG" },
  { id: plId(), period: "2026-02", accountCode: "400-1001", accountName: "Sales - Bedframe", category: "REVENUE", amount: 6363600, productCategory: "BEDFRAME", customerId: "hub-houzs-srw", customerName: "Houzs SRW", state: "SRW" },
  { id: plId(), period: "2026-02", accountCode: "400-1001", accountName: "Sales - Bedframe", category: "REVENUE", amount: 3636400, productCategory: "BEDFRAME", customerId: "hub-houzs-sbh", customerName: "Houzs SBH", state: "SBH" },
  { id: plId(), period: "2026-02", accountCode: "400-1001", accountName: "Sales - Bedframe", category: "REVENUE", amount: 10000000, productCategory: "BEDFRAME", customerId: "hub-carress", customerName: "Carress", state: "KL" },
  { id: plId(), period: "2026-02", accountCode: "400-1001", accountName: "Sales - Bedframe", category: "REVENUE", amount: 5000000, productCategory: "BEDFRAME", customerId: "hub-conts", customerName: "The Conts", state: "JB" },
  // Revenue - Sofa
  { id: plId(), period: "2026-02", accountCode: "400-1002", accountName: "Sales - Sofa", category: "REVENUE", amount: 17272700, productCategory: "SOFA", customerId: "hub-houzs-kl", customerName: "Houzs KL", state: "KL" },
  { id: plId(), period: "2026-02", accountCode: "400-1002", accountName: "Sales - Sofa", category: "REVENUE", amount: 11818200, productCategory: "SOFA", customerId: "hub-houzs-pg", customerName: "Houzs PG", state: "PG" },
  { id: plId(), period: "2026-02", accountCode: "400-1002", accountName: "Sales - Sofa", category: "REVENUE", amount: 7272700, productCategory: "SOFA", customerId: "hub-carress", customerName: "Carress", state: "KL" },
  { id: plId(), period: "2026-02", accountCode: "400-1002", accountName: "Sales - Sofa", category: "REVENUE", amount: 4090900, productCategory: "SOFA", customerId: "hub-conts", customerName: "The Conts", state: "JB" },
  // Revenue - Accessories
  { id: plId(), period: "2026-02", accountCode: "400-1003", accountName: "Sales - Accessories", category: "REVENUE", amount: 2000000, productCategory: "ACCESSORY", customerId: "hub-houzs-kl", customerName: "Houzs KL", state: "KL" },
  { id: plId(), period: "2026-02", accountCode: "400-1003", accountName: "Sales - Accessories", category: "REVENUE", amount: 1090900, productCategory: "ACCESSORY", customerId: "hub-carress", customerName: "Carress", state: "KL" },
  // COGS - February
  { id: plId(), period: "2026-02", accountCode: "330-1001", accountName: "COGS - BM Fabric", category: "COGS", amount: 9200000, productCategory: "ALL" },
  { id: plId(), period: "2026-02", accountCode: "330-1002", accountName: "COGS - SM Fabric", category: "COGS", amount: 6800000, productCategory: "ALL" },
  { id: plId(), period: "2026-02", accountCode: "330-1003", accountName: "COGS - Plywood", category: "COGS", amount: 5200000, productCategory: "ALL" },
  { id: plId(), period: "2026-02", accountCode: "330-1004", accountName: "COGS - Wood Strip", category: "COGS", amount: 2300000, productCategory: "ALL" },
  { id: plId(), period: "2026-02", accountCode: "330-1005", accountName: "COGS - Foam & Filler", category: "COGS", amount: 6100000, productCategory: "ALL" },
  { id: plId(), period: "2026-02", accountCode: "330-1006", accountName: "COGS - Accessories", category: "COGS", amount: 1650000, productCategory: "ALL" },
  { id: plId(), period: "2026-02", accountCode: "330-1007", accountName: "COGS - Webbing", category: "COGS", amount: 880000, productCategory: "ALL" },
  { id: plId(), period: "2026-02", accountCode: "330-1008", accountName: "COGS - Packing", category: "COGS", amount: 1300000, productCategory: "ALL" },
  { id: plId(), period: "2026-02", accountCode: "330-1009", accountName: "COGS - Direct Labour", category: "COGS", amount: 10200000, productCategory: "ALL" },
  // Operating Expenses - February
  { id: plId(), period: "2026-02", accountCode: "500-1001", accountName: "Salaries & Wages (Admin)", category: "OPERATING_EXPENSE", amount: 4500000 },
  { id: plId(), period: "2026-02", accountCode: "500-1002", accountName: "EPF & SOCSO", category: "OPERATING_EXPENSE", amount: 1200000 },
  { id: plId(), period: "2026-02", accountCode: "500-1003", accountName: "Rental - Factory", category: "OPERATING_EXPENSE", amount: 2800000 },
  { id: plId(), period: "2026-02", accountCode: "500-1004", accountName: "Utilities", category: "OPERATING_EXPENSE", amount: 920000 },
  { id: plId(), period: "2026-02", accountCode: "500-1005", accountName: "Depreciation", category: "OPERATING_EXPENSE", amount: 1500000 },
  { id: plId(), period: "2026-02", accountCode: "500-1006", accountName: "Transport & Delivery", category: "OPERATING_EXPENSE", amount: 2400000 },
  { id: plId(), period: "2026-02", accountCode: "500-1007", accountName: "Insurance", category: "OPERATING_EXPENSE", amount: 350000 },
  { id: plId(), period: "2026-02", accountCode: "500-1008", accountName: "Maintenance & Repairs", category: "OPERATING_EXPENSE", amount: 520000 },
  { id: plId(), period: "2026-02", accountCode: "500-1009", accountName: "Office Supplies", category: "OPERATING_EXPENSE", amount: 200000 },

  // ===== MARCH 2026 =====
  // Revenue - Bedframe
  { id: plId(), period: "2026-03", accountCode: "400-1001", accountName: "Sales - Bedframe", category: "REVENUE", amount: 14545500, productCategory: "BEDFRAME", customerId: "hub-houzs-kl", customerName: "Houzs KL", state: "KL" },
  { id: plId(), period: "2026-03", accountCode: "400-1001", accountName: "Sales - Bedframe", category: "REVENUE", amount: 10000000, productCategory: "BEDFRAME", customerId: "hub-houzs-pg", customerName: "Houzs PG", state: "PG" },
  { id: plId(), period: "2026-03", accountCode: "400-1001", accountName: "Sales - Bedframe", category: "REVENUE", amount: 6818200, productCategory: "BEDFRAME", customerId: "hub-houzs-srw", customerName: "Houzs SRW", state: "SRW" },
  { id: plId(), period: "2026-03", accountCode: "400-1001", accountName: "Sales - Bedframe", category: "REVENUE", amount: 4090900, productCategory: "BEDFRAME", customerId: "hub-houzs-sbh", customerName: "Houzs SBH", state: "SBH" },
  { id: plId(), period: "2026-03", accountCode: "400-1001", accountName: "Sales - Bedframe", category: "REVENUE", amount: 10909100, productCategory: "BEDFRAME", customerId: "hub-carress", customerName: "Carress", state: "KL" },
  { id: plId(), period: "2026-03", accountCode: "400-1001", accountName: "Sales - Bedframe", category: "REVENUE", amount: 5454500, productCategory: "BEDFRAME", customerId: "hub-conts", customerName: "The Conts", state: "JB" },
  // Revenue - Sofa
  { id: plId(), period: "2026-03", accountCode: "400-1002", accountName: "Sales - Sofa", category: "REVENUE", amount: 18181800, productCategory: "SOFA", customerId: "hub-houzs-kl", customerName: "Houzs KL", state: "KL" },
  { id: plId(), period: "2026-03", accountCode: "400-1002", accountName: "Sales - Sofa", category: "REVENUE", amount: 12727300, productCategory: "SOFA", customerId: "hub-houzs-pg", customerName: "Houzs PG", state: "PG" },
  { id: plId(), period: "2026-03", accountCode: "400-1002", accountName: "Sales - Sofa", category: "REVENUE", amount: 7727300, productCategory: "SOFA", customerId: "hub-carress", customerName: "Carress", state: "KL" },
  { id: plId(), period: "2026-03", accountCode: "400-1002", accountName: "Sales - Sofa", category: "REVENUE", amount: 4545500, productCategory: "SOFA", customerId: "hub-conts", customerName: "The Conts", state: "JB" },
  // Revenue - Accessories
  { id: plId(), period: "2026-03", accountCode: "400-1003", accountName: "Sales - Accessories", category: "REVENUE", amount: 2272700, productCategory: "ACCESSORY", customerId: "hub-houzs-kl", customerName: "Houzs KL", state: "KL" },
  { id: plId(), period: "2026-03", accountCode: "400-1003", accountName: "Sales - Accessories", category: "REVENUE", amount: 1363600, productCategory: "ACCESSORY", customerId: "hub-carress", customerName: "Carress", state: "KL" },
  { id: plId(), period: "2026-03", accountCode: "400-1003", accountName: "Sales - Accessories", category: "REVENUE", amount: 454500, productCategory: "ACCESSORY", customerId: "hub-houzs-pg", customerName: "Houzs PG", state: "PG" },
  // COGS - March
  { id: plId(), period: "2026-03", accountCode: "330-1001", accountName: "COGS - BM Fabric", category: "COGS", amount: 9800000, productCategory: "ALL" },
  { id: plId(), period: "2026-03", accountCode: "330-1002", accountName: "COGS - SM Fabric", category: "COGS", amount: 7200000, productCategory: "ALL" },
  { id: plId(), period: "2026-03", accountCode: "330-1003", accountName: "COGS - Plywood", category: "COGS", amount: 5500000, productCategory: "ALL" },
  { id: plId(), period: "2026-03", accountCode: "330-1004", accountName: "COGS - Wood Strip", category: "COGS", amount: 2500000, productCategory: "ALL" },
  { id: plId(), period: "2026-03", accountCode: "330-1005", accountName: "COGS - Foam & Filler", category: "COGS", amount: 6500000, productCategory: "ALL" },
  { id: plId(), period: "2026-03", accountCode: "330-1006", accountName: "COGS - Accessories", category: "COGS", amount: 1800000, productCategory: "ALL" },
  { id: plId(), period: "2026-03", accountCode: "330-1007", accountName: "COGS - Webbing", category: "COGS", amount: 950000, productCategory: "ALL" },
  { id: plId(), period: "2026-03", accountCode: "330-1008", accountName: "COGS - Packing", category: "COGS", amount: 1400000, productCategory: "ALL" },
  { id: plId(), period: "2026-03", accountCode: "330-1009", accountName: "COGS - Direct Labour", category: "COGS", amount: 10800000, productCategory: "ALL" },
  // Operating Expenses - March
  { id: plId(), period: "2026-03", accountCode: "500-1001", accountName: "Salaries & Wages (Admin)", category: "OPERATING_EXPENSE", amount: 4500000 },
  { id: plId(), period: "2026-03", accountCode: "500-1002", accountName: "EPF & SOCSO", category: "OPERATING_EXPENSE", amount: 1200000 },
  { id: plId(), period: "2026-03", accountCode: "500-1003", accountName: "Rental - Factory", category: "OPERATING_EXPENSE", amount: 2800000 },
  { id: plId(), period: "2026-03", accountCode: "500-1004", accountName: "Utilities", category: "OPERATING_EXPENSE", amount: 980000 },
  { id: plId(), period: "2026-03", accountCode: "500-1005", accountName: "Depreciation", category: "OPERATING_EXPENSE", amount: 1500000 },
  { id: plId(), period: "2026-03", accountCode: "500-1006", accountName: "Transport & Delivery", category: "OPERATING_EXPENSE", amount: 2600000 },
  { id: plId(), period: "2026-03", accountCode: "500-1007", accountName: "Insurance", category: "OPERATING_EXPENSE", amount: 350000 },
  { id: plId(), period: "2026-03", accountCode: "500-1008", accountName: "Maintenance & Repairs", category: "OPERATING_EXPENSE", amount: 600000 },
  { id: plId(), period: "2026-03", accountCode: "500-1009", accountName: "Office Supplies", category: "OPERATING_EXPENSE", amount: 220000 },
];
...
export const balanceSheetEntries: BalanceSheetEntry[] = [
  // Current Assets
  { id: "bs-1", accountCode: "100-1001", accountName: "Cash & Bank", category: "CURRENT_ASSET", balance: 28500000, asOfDate: "2026-03-31" },
  { id: "bs-2", accountCode: "100-1002", accountName: "Accounts Receivable", category: "CURRENT_ASSET", balance: 42000000, asOfDate: "2026-03-31" },
  { id: "bs-3", accountCode: "100-1003", accountName: "Inventory - Raw Materials", category: "CURRENT_ASSET", balance: 18500000, asOfDate: "2026-03-31" },
  { id: "bs-4", accountCode: "100-1004", accountName: "Inventory - WIP", category: "CURRENT_ASSET", balance: 8200000, asOfDate: "2026-03-31" },
  { id: "bs-5", accountCode: "100-1005", accountName: "Inventory - Finished Goods", category: "CURRENT_ASSET", balance: 12800000, asOfDate: "2026-03-31" },
  { id: "bs-6", accountCode: "100-1006", accountName: "Prepaid Expenses", category: "CURRENT_ASSET", balance: 3500000, asOfDate: "2026-03-31" },
  // Fixed Assets
  { id: "bs-7", accountCode: "150-1001", accountName: "Plant & Machinery", category: "FIXED_ASSET", balance: 45000000, asOfDate: "2026-03-31" },
  { id: "bs-8", accountCode: "150-1002", accountName: "Acc. Depreciation - P&M", category: "FIXED_ASSET", balance: -12000000, asOfDate: "2026-03-31" },
  { id: "bs-9", accountCode: "150-1003", accountName: "Furniture & Fittings", category: "FIXED_ASSET", balance: 5000000, asOfDate: "2026-03-31" },
  { id: "bs-10", accountCode: "150-1004", accountName: "Acc. Depreciation - F&F", category: "FIXED_ASSET", balance: -2000000, asOfDate: "2026-03-31" },
  { id: "bs-11", accountCode: "150-1005", accountName: "Motor Vehicles", category: "FIXED_ASSET", balance: 18000000, asOfDate: "2026-03-31" },
  { id: "bs-12", accountCode: "150-1006", accountName: "Acc. Depreciation - MV", category: "FIXED_ASSET", balance: -5500000, asOfDate: "2026-03-31" },
  // Current Liabilities
  { id: "bs-13", accountCode: "200-1001", accountName: "Accounts Payable", category: "CURRENT_LIABILITY", balance: 22000000, asOfDate: "2026-03-31" },
  { id: "bs-15", accountCode: "200-1003", accountName: "Accrued Expenses", category: "CURRENT_LIABILITY", balance: 5800000, asOfDate: "2026-03-31" },
  { id: "bs-16", accountCode: "200-1004", accountName: "EPF & SOCSO Payable", category: "CURRENT_LIABILITY", balance: 1200000, asOfDate: "2026-03-31" },
  // Long-Term Liabilities
  { id: "bs-17", accountCode: "250-1001", accountName: "HP - Machinery", category: "LONG_TERM_LIABILITY", balance: 15000000, asOfDate: "2026-03-31" },
  { id: "bs-18", accountCode: "250-1002", accountName: "HP - Motor Vehicles", category: "LONG_TERM_LIABILITY", balance: 12000000, asOfDate: "2026-03-31" },
  // Equity
  { id: "bs-19", accountCode: "300-1001", accountName: "Share Capital", category: "EQUITY", balance: 50000000, asOfDate: "2026-03-31" },
  { id: "bs-20", accountCode: "300-1002", accountName: "Retained Earnings", category: "EQUITY", balance: 44941100, asOfDate: "2026-03-31" },
];
...
export const deptLeadTimes: DeptLeadTime[] = [
  { deptCode: "FAB_CUT", deptName: "Fabric Cutting", bedframeDays: 7, sofaDays: 10 },
  { deptCode: "FAB_SEW", deptName: "Fabric Sewing", bedframeDays: 5, sofaDays: 8 },
  { deptCode: "FOAM", deptName: "Foam Bonding", bedframeDays: 3, sofaDays: 5 },
  { deptCode: "WOOD_CUT", deptName: "Wood Cutting", bedframeDays: 4, sofaDays: 7 },
  { deptCode: "FRAMING", deptName: "Framing", bedframeDays: 3, sofaDays: 6 },
  { deptCode: "WEBBING", deptName: "Webbing", bedframeDays: 3, sofaDays: 6 },
  { deptCode: "UPHOLSTERY", deptName: "Upholstery", bedframeDays: 2, sofaDays: 4 },
  { deptCode: "PACKING", deptName: "Packing", bedframeDays: 2, sofaDays: 3 },
];

export const scheduleEntries: ScheduleEntry[] = [
  {
    id: "sched-1", productionOrderId: productionOrders[0]?.id || "",
    soNumber: "SO-2604-045-01", productCode: "5535-2A", category: "SOFA",
    customerDeliveryDate: "2026-04-25", customerName: "CARRESS SDN BHD",
    deptSchedule: [
      { deptCode: "FAB_CUT", deptName: "Fabric Cutting", startDate: "2026-03-26", endDate: "2026-04-07", minutes: 120, status: "COMPLETED" },
      { deptCode: "FAB_SEW", deptName: "Fabric Sewing", startDate: "2026-04-07", endDate: "2026-04-16", minutes: 130, status: "COMPLETED" },
      { deptCode: "FOAM", deptName: "Foam Bonding", startDate: "2026-04-09", endDate: "2026-04-16", minutes: 80, status: "COMPLETED" },
      { deptCode: "WOOD_CUT", deptName: "Wood Cutting", startDate: "2026-03-31", endDate: "2026-04-08", minutes: 90, status: "COMPLETED" },
      { deptCode: "FRAMING", deptName: "Framing", startDate: "2026-04-08", endDate: "2026-04-16", minutes: 140, status: "COMPLETED" },
      { deptCode: "WEBBING", deptName: "Webbing", startDate: "2026-04-08", endDate: "2026-04-16", minutes: 70, status: "COMPLETED" },
      { deptCode: "UPHOLSTERY", deptName: "Upholstery", startDate: "2026-04-16", endDate: "2026-04-21", minutes: 160, status: "IN_PROGRESS" },
      { deptCode: "PACKING", deptName: "Packing", startDate: "2026-04-21", endDate: "2026-04-24", minutes: 60, status: "SCHEDULED" },
    ],
    hookkaExpectedDD: "2026-04-24",
  },
  {
    id: "sched-2", productionOrderId: productionOrders[1]?.id || "",
    soNumber: "SO-2604-045-02", productCode: "5535-1NA", category: "SOFA",
    customerDeliveryDate: "2026-04-25", customerName: "CARRESS SDN BHD",
    deptSchedule: [
      { deptCode: "FAB_CUT", deptName: "Fabric Cutting", startDate: "2026-03-26", endDate: "2026-04-07", minutes: 100, status: "COMPLETED" },
      { deptCode: "FAB_SEW", deptName: "Fabric Sewing", startDate: "2026-04-07", endDate: "2026-04-16", minutes: 120, status: "COMPLETED" },
      { deptCode: "FOAM", deptName: "Foam Bonding", startDate: "2026-04-09", endDate: "2026-04-16", minutes: 70, status: "COMPLETED" },
      { deptCode: "WOOD_CUT", deptName: "Wood Cutting", startDate: "2026-03-31", endDate: "2026-04-08", minutes: 80, status: "COMPLETED" },
      { deptCode: "FRAMING", deptName: "Framing", startDate: "2026-04-08", endDate: "2026-04-16", minutes: 120, status: "IN_PROGRESS" },
      { deptCode: "WEBBING", deptName: "Webbing", startDate: "2026-04-08", endDate: "2026-04-16", minutes: 60, status: "SCHEDULED" },
      { deptCode: "UPHOLSTERY", deptName: "Upholstery", startDate: "2026-04-16", endDate: "2026-04-21", minutes: 140, status: "SCHEDULED" },
      { deptCode: "PACKING", deptName: "Packing", startDate: "2026-04-21", endDate: "2026-04-24", minutes: 50, status: "SCHEDULED" },
    ],
    hookkaExpectedDD: "2026-04-24",
  },
  {
    id: "sched-3", productionOrderId: productionOrders[2]?.id || "",
    soNumber: "SO-2604-045-03", productCode: "5535-CNR", category: "SOFA",
    customerDeliveryDate: "2026-04-25", customerName: "CARRESS SDN BHD",
    deptSchedule: [
      { deptCode: "FAB_CUT", deptName: "Fabric Cutting", startDate: "2026-03-26", endDate: "2026-04-07", minutes: 90, status: "COMPLETED" },
      { deptCode: "FAB_SEW", deptName: "Fabric Sewing", startDate: "2026-04-07", endDate: "2026-04-16", minutes: 110, status: "IN_PROGRESS" },
      { deptCode: "FOAM", deptName: "Foam Bonding", startDate: "2026-04-09", endDate: "2026-04-16", minutes: 65, status: "SCHEDULED" },
      { deptCode: "WOOD_CUT", deptName: "Wood Cutting", startDate: "2026-03-31", endDate: "2026-04-08", minutes: 70, status: "COMPLETED" },
      { deptCode: "FRAMING", deptName: "Framing", startDate: "2026-04-08", endDate: "2026-04-16", minutes: 110, status: "SCHEDULED" },
      { deptCode: "WEBBING", deptName: "Webbing", startDate: "2026-04-08", endDate: "2026-04-16", minutes: 55, status: "SCHEDULED" },
      { deptCode: "UPHOLSTERY", deptName: "Upholstery", startDate: "2026-04-16", endDate: "2026-04-21", minutes: 130, status: "SCHEDULED" },
      { deptCode: "PACKING", deptName: "Packing", startDate: "2026-04-21", endDate: "2026-04-24", minutes: 45, status: "SCHEDULED" },
    ],
    hookkaExpectedDD: "2026-04-24",
  },
  {
    id: "sched-4", productionOrderId: productionOrders[3]?.id || "",
    soNumber: "SO-2604-044-01", productCode: "1009(A)", category: "BEDFRAME",
    customerDeliveryDate: "2026-04-22", customerName: "Houzs Century",
    deptSchedule: [
      { deptCode: "FAB_CUT", deptName: "Fabric Cutting", startDate: "2026-03-28", endDate: "2026-04-06", minutes: 100, status: "COMPLETED" },
      { deptCode: "FAB_SEW", deptName: "Fabric Sewing", startDate: "2026-04-06", endDate: "2026-04-11", minutes: 110, status: "COMPLETED" },
      { deptCode: "FOAM", deptName: "Foam Bonding", startDate: "2026-04-08", endDate: "2026-04-11", minutes: 80, status: "COMPLETED" },
      { deptCode: "WOOD_CUT", deptName: "Wood Cutting", startDate: "2026-04-01", endDate: "2026-04-06", minutes: 100, status: "COMPLETED" },
      { deptCode: "FRAMING", deptName: "Framing", startDate: "2026-04-06", endDate: "2026-04-11", minutes: 130, status: "COMPLETED" },
      { deptCode: "WEBBING", deptName: "Webbing", startDate: "2026-04-06", endDate: "2026-04-11", minutes: 60, status: "COMPLETED" },
      { deptCode: "UPHOLSTERY", deptName: "Upholstery", startDate: "2026-04-11", endDate: "2026-04-14", minutes: 150, status: "COMPLETED" },
      { deptCode: "PACKING", deptName: "Packing", startDate: "2026-04-14", endDate: "2026-04-16", minutes: 60, status: "COMPLETED" },
    ],
    hookkaExpectedDD: "2026-04-20",
  },
  {
    id: "sched-5", productionOrderId: productionOrders[4]?.id || "",
    soNumber: "SO-2604-044-02", productCode: "1003(A)", category: "BEDFRAME",
    customerDeliveryDate: "2026-04-22", customerName: "Houzs Century",
    deptSchedule: [
      { deptCode: "FAB_CUT", deptName: "Fabric Cutting", startDate: "2026-03-28", endDate: "2026-04-06", minutes: 110, status: "COMPLETED" },
      { deptCode: "FAB_SEW", deptName: "Fabric Sewing", startDate: "2026-04-06", endDate: "2026-04-11", minutes: 120, status: "COMPLETED" },
      { deptCode: "FOAM", deptName: "Foam Bonding", startDate: "2026-04-08", endDate: "2026-04-11", minutes: 76, status: "COMPLETED" },
      { deptCode: "WOOD_CUT", deptName: "Wood Cutting", startDate: "2026-04-01", endDate: "2026-04-06", minutes: 90, status: "COMPLETED" },
      { deptCode: "FRAMING", deptName: "Framing", startDate: "2026-04-06", endDate: "2026-04-11", minutes: 120, status: "COMPLETED" },
      { deptCode: "WEBBING", deptName: "Webbing", startDate: "2026-04-06", endDate: "2026-04-11", minutes: 56, status: "COMPLETED" },
      { deptCode: "UPHOLSTERY", deptName: "Upholstery", startDate: "2026-04-11", endDate: "2026-04-14", minutes: 140, status: "COMPLETED" },
      { deptCode: "PACKING", deptName: "Packing", startDate: "2026-04-14", endDate: "2026-04-16", minutes: 50, status: "COMPLETED" },
    ],
    hookkaExpectedDD: "2026-04-20",
  },
  {
    id: "sched-6", productionOrderId: "",
    soNumber: "SO-2604-043-01", productCode: "1009(A)", category: "BEDFRAME",
    customerDeliveryDate: "2026-04-28", customerName: "Houzs Century",
    deptSchedule: [
      { deptCode: "FAB_CUT", deptName: "Fabric Cutting", startDate: "2026-04-02", endDate: "2026-04-11", minutes: 100, status: "OVERDUE" },
      { deptCode: "FAB_SEW", deptName: "Fabric Sewing", startDate: "2026-04-11", endDate: "2026-04-17", minutes: 110, status: "SCHEDULED" },
      { deptCode: "FOAM", deptName: "Foam Bonding", startDate: "2026-04-14", endDate: "2026-04-17", minutes: 80, status: "SCHEDULED" },
      { deptCode: "WOOD_CUT", deptName: "Wood Cutting", startDate: "2026-04-07", endDate: "2026-04-11", minutes: 100, status: "SCHEDULED" },
      { deptCode: "FRAMING", deptName: "Framing", startDate: "2026-04-11", endDate: "2026-04-17", minutes: 130, status: "SCHEDULED" },
      { deptCode: "WEBBING", deptName: "Webbing", startDate: "2026-04-11", endDate: "2026-04-17", minutes: 60, status: "SCHEDULED" },
      { deptCode: "UPHOLSTERY", deptName: "Upholstery", startDate: "2026-04-17", endDate: "2026-04-21", minutes: 150, status: "SCHEDULED" },
      { deptCode: "PACKING", deptName: "Packing", startDate: "2026-04-21", endDate: "2026-04-23", minutes: 60, status: "SCHEDULED" },
    ],
    hookkaExpectedDD: "2026-04-25",
  },
  {
    id: "sched-7", productionOrderId: "",
    soNumber: "SO-2604-043-02", productCode: "1013", category: "BEDFRAME",
    customerDeliveryDate: "2026-04-28", customerName: "Houzs Century",
    deptSchedule: [
      { deptCode: "FAB_CUT", deptName: "Fabric Cutting", startDate: "2026-04-02", endDate: "2026-04-11", minutes: 95, status: "OVERDUE" },
      { deptCode: "FAB_SEW", deptName: "Fabric Sewing", startDate: "2026-04-11", endDate: "2026-04-17", minutes: 105, status: "SCHEDULED" },
      { deptCode: "FOAM", deptName: "Foam Bonding", startDate: "2026-04-14", endDate: "2026-04-17", minutes: 75, status: "SCHEDULED" },
      { deptCode: "WOOD_CUT", deptName: "Wood Cutting", startDate: "2026-04-07", endDate: "2026-04-11", minutes: 95, status: "SCHEDULED" },
      { deptCode: "FRAMING", deptName: "Framing", startDate: "2026-04-11", endDate: "2026-04-17", minutes: 125, status: "SCHEDULED" },
      { deptCode: "WEBBING", deptName: "Webbing", startDate: "2026-04-11", endDate: "2026-04-17", minutes: 55, status: "SCHEDULED" },
      { deptCode: "UPHOLSTERY", deptName: "Upholstery", startDate: "2026-04-17", endDate: "2026-04-21", minutes: 140, status: "SCHEDULED" },
      { deptCode: "PACKING", deptName: "Packing", startDate: "2026-04-21", endDate: "2026-04-23", minutes: 55, status: "SCHEDULED" },
    ],
    hookkaExpectedDD: "2026-04-25",
  },
  {
    id: "sched-8", productionOrderId: "",
    soNumber: "SO-2604-038-01", productCode: "1009(A)", category: "BEDFRAME",
    customerDeliveryDate: "2026-04-30", customerName: "Houzs Century",
    deptSchedule: [
      { deptCode: "FAB_CUT", deptName: "Fabric Cutting", startDate: "2026-04-04", endDate: "2026-04-14", minutes: 120, status: "IN_PROGRESS" },
      { deptCode: "FAB_SEW", deptName: "Fabric Sewing", startDate: "2026-04-14", endDate: "2026-04-21", minutes: 130, status: "SCHEDULED" },
      { deptCode: "FOAM", deptName: "Foam Bonding", startDate: "2026-04-16", endDate: "2026-04-21", minutes: 90, status: "SCHEDULED" },
      { deptCode: "WOOD_CUT", deptName: "Wood Cutting", startDate: "2026-04-09", endDate: "2026-04-14", minutes: 110, status: "SCHEDULED" },
      { deptCode: "FRAMING", deptName: "Framing", startDate: "2026-04-14", endDate: "2026-04-21", minutes: 140, status: "SCHEDULED" },
      { deptCode: "WEBBING", deptName: "Webbing", startDate: "2026-04-14", endDate: "2026-04-21", minutes: 65, status: "SCHEDULED" },
      { deptCode: "UPHOLSTERY", deptName: "Upholstery", startDate: "2026-04-21", endDate: "2026-04-23", minutes: 160, status: "SCHEDULED" },
      { deptCode: "PACKING", deptName: "Packing", startDate: "2026-04-23", endDate: "2026-04-27", minutes: 65, status: "SCHEDULED" },
    ],
    hookkaExpectedDD: "2026-04-28",
  },
  {
    id: "sched-9", productionOrderId: "",
    soNumber: "SO-2604-038-02", productCode: "1003(A)", category: "BEDFRAME",
    customerDeliveryDate: "2026-04-30", customerName: "Houzs Century",
    deptSchedule: [
      { deptCode: "FAB_CUT", deptName: "Fabric Cutting", startDate: "2026-04-04", endDate: "2026-04-14", minutes: 110, status: "IN_PROGRESS" },
      { deptCode: "FAB_SEW", deptName: "Fabric Sewing", startDate: "2026-04-14", endDate: "2026-04-21", minutes: 120, status: "SCHEDULED" },
      { deptCode: "FOAM", deptName: "Foam Bonding", startDate: "2026-04-16", endDate: "2026-04-21", minutes: 85, status: "SCHEDULED" },
      { deptCode: "WOOD_CUT", deptName: "Wood Cutting", startDate: "2026-04-09", endDate: "2026-04-14", minutes: 100, status: "SCHEDULED" },
      { deptCode: "FRAMING", deptName: "Framing", startDate: "2026-04-14", endDate: "2026-04-21", minutes: 130, status: "SCHEDULED" },
      { deptCode: "WEBBING", deptName: "Webbing", startDate: "2026-04-14", endDate: "2026-04-21", minutes: 60, status: "SCHEDULED" },
      { deptCode: "UPHOLSTERY", deptName: "Upholstery", startDate: "2026-04-21", endDate: "2026-04-23", minutes: 150, status: "SCHEDULED" },
      { deptCode: "PACKING", deptName: "Packing", startDate: "2026-04-23", endDate: "2026-04-27", minutes: 55, status: "SCHEDULED" },
    ],
    hookkaExpectedDD: "2026-04-28",
  },
];
