...
-- ============================================================================
ALTER TABLE job_cards ADD COLUMN branchKey TEXT;

CREATE INDEX IF NOT EXISTS idx_job_cards_wipKey_branchKey
  ON job_cards(wipKey, branchKey);
...
UPDATE job_cards SET branchKey = ''
  WHERE departmentCode IN ('UPHOLSTERY','PACKING');
...
UPDATE job_cards SET branchKey = 'Foam'
  WHERE branchKey IS NULL
    ...
    AND wipKey IN ('SOFA_BASE','SOFA_CUSHION','SOFA_ARMREST','SOFA_HEADREST');
