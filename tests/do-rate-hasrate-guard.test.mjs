// ---------------------------------------------------------------------------
// do-rate-hasrate-guard.test.mjs â€” DO create-path 0/0 rate guard.
//
...
// vehicle (rates never keyed in 3PL Maintenance â†’ 0/0) used to "win"
...
// as UNSET (hasRate fall-through vehicleâ†’provider). This test asserts the DO
...
// three-pl-state-rates.test.mjs / e2e-happy-path.test.mjs â€” the logic lives
...
// 2026-08-01: hasRatePair moved into _helpers.ts when the route was split. This test read only the route file, so it went red the
...
test("DO guard is additive â€” explicit deliveryCostSen still wins", () => {
