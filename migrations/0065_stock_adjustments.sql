...
CREATE TABLE stock_adjustments (
  ...
  itemCode TEXT NOT NULL,             -- denormalised display key
  itemName TEXT,
  ...
  totalCostSen INTEGER NOT NULL DEFAULT 0,
...
CREATE INDEX idx_stock_adjustments_itemId ON stock_adjustments(itemId);
CREATE INDEX idx_stock_adjustments_type ON stock_adjustments(type);
CREATE INDEX idx_stock_adjustments_adjustedAt ON stock_adjustments(adjustedAt);
