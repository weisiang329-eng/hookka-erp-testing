...
| 4 | **Navigation** | go straight to the files — **no searching** | 🔨 building now | `NAVIGATION-MAP` (module → page → route → table → test + big-file section index) |
| 5 | **Methodology** | fixed steps for recurring tasks | ⏭️ next | `PLAYBOOKS` |
